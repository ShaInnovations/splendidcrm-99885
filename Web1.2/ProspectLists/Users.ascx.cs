	...
	public class Users : SplendidControl
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if ( !Sql.IsEmptyString(txtUSER_ID.Value) )
			{
				...
				{
					SqlProcs.spPROSPECT_LISTS_USERS_MassUpdate(sIDs, gID);
					Response.Redirect("view.aspx?ID=" + gID.ToString());
				}
			}
...
#if DEBUG
					Page.RegisterClientScriptBlock("vwPROSPECT_LISTS_USERS", Sql.ClientScriptBlock(cmd));
#endif
					try
					{
		...
		private void InitializeComponent()
		{
			...
			grdMain.DynamicColumns("ProspectLists.Users");
		}
		#endregion
	}
}
