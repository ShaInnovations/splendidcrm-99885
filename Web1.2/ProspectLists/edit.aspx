<%@ Page language="c#" Codebehind="edit.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.ProspectLists.Edit" %>
...
<form id="frmMain" method="post" runat="server">
	...
	<SplendidCRM:Header ID="ctlHeader" Visible="<%# !PrintView %>" ActiveTab="ProspectLists" Runat="Server" />
