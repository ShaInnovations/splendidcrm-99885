...
<div id="divEditView">
	...
	<SplendidCRM:ModuleHeader ID="ctlModuleHeader" Module="Meetings" EnablePrint="false" EnableHelp="true" Runat="Server" />
	<p>
	...
	<input id="txtINVITEE_ID" type="hidden" runat="server" NAME="txtINVITEE_ID"/>
