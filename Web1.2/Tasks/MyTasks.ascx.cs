...
namespace SplendidCRM.Tasks
{
	...
	/// </summary>
	public class MyTasks : SplendidControl
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			using ( IDbConnection con = dbf.CreateConnection() )
			{
				...
				sSQL = "select *                                   " + ControlChars.CrLf
				     + "  from vwTASKS_MyList                      " + ControlChars.CrLf
				     + " where ASSIGNED_USER_ID = @ASSIGNED_USER_ID" + ControlChars.CrLf
				     + " order by DATE_DUE asc, PRIORITY desc      " + ControlChars.CrLf;
		...
		private void InitializeComponent()
		{
			...
			grdMain.DynamicColumns("Tasks.MyTasks");
		}
		#endregion
	}
}
