...
<div id="divDetailView">
	...
	<SplendidCRM:ModuleHeader ID="ctlModuleHeader" Module="Employees" EnablePrint="true" EnableHelp="true" Runat="Server" />
	...
	<table ID="tblMain" width="100%" border="0" cellspacing="0" cellpadding="0" class="tabDetailView" runat="server">
		<tr>
			<th valign="top" align="left" colspan="4" class="tabDetailViewDL"><h4 class="tabDetailViewDL"><%= L10n.Term("Employees.LBL_EMPLOYEE_INFORMATION") %></h4></th>
		</tr>
	</table>
