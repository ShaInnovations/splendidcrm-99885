<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SearchBasic.ascx.cs" Inherits="SplendidCRM.Employees.SearchBasic" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<div id="divSearch">
		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td class="dataLabel" noWrap><%= L10n.Term("Employees.LBL_FIRST_NAME"     ) %>&nbsp;&nbsp;<asp:TextBox ID="txtFIRST_NAME" CssClass="dataField" size="10" Runat="server" /></td>
						<td class="dataLabel" noWrap><%= L10n.Term("Employees.LBL_LAST_NAME"      ) %>&nbsp;&nbsp;<asp:TextBox ID="txtLAST_NAME"  CssClass="dataField" size="10" Runat="server" /></td>
						<td class="dataLabel" noWrap><%= L10n.Term("Employees.LBL_DEPARTMENT"     ) %>&nbsp;&nbsp;<asp:TextBox ID="txtDEPARTMENT" CssClass="dataField" size="10" Runat="server" /></td>
						<td class="dataLabel" noWrap><%= L10n.Term("Employees.LBL_EMPLOYEE_STATUS") %>&nbsp;&nbsp;<asp:DropDownList ID="lstEMPLOYEE_STATUS" DataValueField="NAME" DataTextField="DISPLAY_NAME" Runat="server" /></td>
						<td align="right">
	...
	<%= Utils.RegisterEnterKeyPress(txtDEPARTMENT.ClientID, btnSearch.ClientID) %>
</div>
