<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SearchPopup.ascx.cs" Inherits="SplendidCRM.Employees.SearchPopup" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td class="dataLabel" noWrap><%= L10n.Term("Employees.LBL_FIRST_NAME") %></td>
						<td class="dataLabel" noWrap><asp:TextBox ID="txtFIRST_NAME" CssClass="dataField" size="20" TabIndex="1" Runat="server" /></td>
						<td class="dataLabel" noWrap><%= L10n.Term("Employees.LBL_USER_NAME" ) %></td>
					...
					<tr>
						<td class="dataLabel" noWrap><%= L10n.Term("Employees.LBL_LAST_NAME"   ) %></td>
