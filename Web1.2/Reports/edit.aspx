<%@ Page language="c#" ValidateRequest="false" Codebehind="edit.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Reports.Edit" %>
...
<form id="frmMain" method="post" runat="server">
	...
	<SplendidCRM:Header ID="ctlHeader" Visible="<%# !PrintView %>" ActiveTab="Reports" Runat="Server" />
	
	<%@ Register TagPrefix="SplendidCRM" Tagname="EditView" Src="EditView.ascx" %>
	<SplendidCRM:EditView ID="ctlEditView" Visible='<%# SplendidCRM.Security.GetUserAccess("Reports", "edit") >= 0 %>' Runat="Server" />
