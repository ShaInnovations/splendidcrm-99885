...
<div id="divDashboardPipelineByMonthByOutcome">
	...
	<div ID="outcome_by_month_edit" style="DISPLAY: none">
		<table cellpadding="0" cellspacing="0" border="0" class="chartForm" align="center">
			<tr>
				<td valign="top" nowrap><b><%= L10n.Term("Dashboard.LBL_YEAR") %></b><br><span class="dateFormat">(yyyy)</span></td>
				<td valign="top">
				...
				<td valign="top" align="right">
					...
					<input type="button" class="button" onclick="toggleDisplay('outcome_by_month_edit');" value='<%= "  " + L10n.Term(".LBL_CANCEL_BUTTON_LABEL") + "  " %>' title='<%= L10n.Term(".LBL_DONE_CANCEL_TITLE") %>' AccessKey='<%= L10n.Term(".LBL_CANCEL_BUTTON_KEY") %>' />
				</td>
			</tr>
		</table>
	</div>
