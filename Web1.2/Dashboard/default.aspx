<%@ Page language="c#" Codebehind="default.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Dashboard.Default" %>
...
<html>
<head>
	<title><%= L10n.Term("Dashboard.LBL_LIST_FORM_TITLE") %></title>
...
<form id="frmMain" method="post" runat="server">
	...
	<SplendidCRM:Header ID="ctlHeader" Visible="<%# !PrintView %>" ActiveTab="Dashboard" Runat="Server" />
