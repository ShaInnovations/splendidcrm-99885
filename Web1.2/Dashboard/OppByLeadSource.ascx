		...
		<table cellpadding="0" cellspacing="0" border="0" class="chartForm" align="center">
			<tr>
				...
				<td valign="top" align="right">
					...
					<input type="button" class="button" onclick="toggleDisplay('pbls_edit');" value='<%= "  " + L10n.Term(".LBL_CANCEL_BUTTON_LABEL") + "  " %>' title='<%= L10n.Term(".LBL_DONE_CANCEL_TITLE") %>' AccessKey='<%= L10n.Term(".LBL_CANCEL_BUTTON_KEY") %>' />
				</td>
			</tr>
		</table>
	</div>
