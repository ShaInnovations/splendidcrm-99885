...
<div id="divListView">
	...
	<SplendidCRM:ModuleHeader ID="ctlModuleHeader" Module="Emails" Title=".moduleList.Home" EnablePrint="true" EnableHelp="true" Runat="Server" />
	<%@ Register TagPrefix="SplendidCRM" Tagname="ListHeader" Src="~/_controls/ListHeader.ascx" %>
	<SplendidCRM:ListHeader Visible="<%# !PrintView %>" Title="Emails.LBL_SEARCH_FORM_TITLE" Runat="Server" />
	<asp:PlaceHolder ID="plcSearch" Visible="<%# !PrintView %>" Runat="server" />
	<br>
	<SplendidCRM:ListHeader Title="Emails.LBL_LIST_FORM_TITLE" Runat="Server" />
		...
		<Columns>
			<asp:TemplateColumn HeaderText="" ItemStyle-Width="1%" ItemStyle-Wrap="false">
				<ItemTemplate>
					...
					<asp:Image Visible='<%# Sql.ToInteger(DataBinder.Eval(Container.DataItem, "ATTACHMENT_COUNT")) > 0 %>' ImageUrl='<%# Session["themeURL"] + "images/attachment.gif" %>'  BorderWidth="0" Width="16" Height="16" Runat="server" />
				</ItemTemplate>
			</asp:TemplateColumn>
		</Columns>
