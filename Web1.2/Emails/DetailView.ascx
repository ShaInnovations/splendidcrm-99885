...
<div id="divDetailView">
	...
	<SplendidCRM:ModuleHeader ID="ctlModuleHeader" Module="Emails" EnablePrint="true" EnableHelp="true" Runat="Server" />
	...
	<table ID="tblAttachments" width="100%" border="0" cellspacing="0" cellpadding="0" class="tabDetailView" runat="server">
		<tr>
