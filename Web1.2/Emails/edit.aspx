<%@ Page language="c#" ValidateRequest="false" Codebehind="edit.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Emails.Edit" %>
...
<body>
<form id="frmMain" method="post" enctype="multipart/form-data" runat="server">
	<%@ Register TagPrefix="SplendidCRM" Tagname="Header" Src="~/_controls/Header.ascx" %>
	<SplendidCRM:Header ID="ctlHeader" Visible="<%# !PrintView %>" ActiveTab="Emails" Runat="Server" />
