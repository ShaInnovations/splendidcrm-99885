		...
		<tr>
			<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td class="dataField"><asp:DropDownList ID="lstOPPORTUNITY_TYPE" DataValueField="NAME" DataTextField="DISPLAY_NAME" Runat="server" /></td>
					...
					<tr>
						...
						<td class="dataField"><asp:DropDownList ID="lstSALES_STAGE" DataValueField="NAME" DataTextField="DISPLAY_NAME" Runat="server" /></td>
					</tr>
				</table>
			</td>
		</tr>
