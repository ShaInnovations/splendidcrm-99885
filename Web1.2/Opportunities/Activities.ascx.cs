...
namespace SplendidCRM.Opportunities
{
	...
	public class Activities : SplendidControl
	{
...
#if DEBUG
					Page.RegisterClientScriptBlock("vwOPPORTUNITIES_ACTIVITIES", Sql.ClientScriptBlock(cmd));
#endif
					try
					{
		...
		private void InitializeComponent()
		{
			...
			grdOpen   .DynamicColumns("Opportunities.Activities.Open"   );
			grdHistory.DynamicColumns("Opportunities.Activities.History");
		}
		#endregion
	}
}
