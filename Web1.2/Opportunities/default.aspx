<%@ Page language="c#" Codebehind="default.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Opportunities.Default" %>
...
<head>
	...
	<SplendidCRM:MetaHeader ID="ctlMetwaHeader" Runat="Server" />
</head>
...
<form id="frmMain" method="post" runat="server">
	...
	<SplendidCRM:Header ID="ctlHeader" Visible="<%# !PrintView %>" ActiveTab="Opportunities" NewRecord="~/Opportunities/NewRecord.ascx" Runat="Server" />
