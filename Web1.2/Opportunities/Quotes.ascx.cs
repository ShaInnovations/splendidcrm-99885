...
namespace SplendidCRM.Opportunities
{
	...
	public class Quotes : SplendidControl
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			using ( IDbConnection con = dbf.CreateConnection() )
			{
				...
				sSQL = "select *                               " + ControlChars.CrLf
				     + "  from vwOPPORTUNITIES_QUOTES          " + ControlChars.CrLf
...
#if DEBUG
					Page.RegisterClientScriptBlock("vwOPPORTUNITIES_QUOTES", Sql.ClientScriptBlock(cmd));
#endif
					try
					{
		...
		private void InitializeComponent()
		{
			...
			grdMain.DynamicColumns("Opportunities.Quotes");
		}
		#endregion
	}
}
