<%@ Page language="c#" Codebehind="default.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.TestRuns.Default" %>
...
<form id="frmMain" method="post" runat="server">
	...
	<SplendidCRM:ListView ID="ctlListView" Visible='<%# SplendidCRM.Security.GetUserAccess("TestRuns", "list") >= 0 %>' Runat="Server" />
