<%@ Control Language="c#" AutoEventWireup="false" Codebehind="MassUpdate.ascx.cs" Inherits="SplendidCRM.TestRuns.MassUpdate" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tabForm">
		<tr>
			<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="25%" class="dataLabel"><%= L10n.Term("TestRuns.LBL_STATUS") %></td>
