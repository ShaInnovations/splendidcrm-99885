<%@ Page language="c#" Codebehind="view.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.TestRuns.View" %>
...
<form id="frmMain" method="post" runat="server">
	...
	<SplendidCRM:DetailView ID="ctlDetailView" Visible='<%# SplendidCRM.Security.GetUserAccess("TestRuns", "view") >= 0 %>' Runat="Server" />
