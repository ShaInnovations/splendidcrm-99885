<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SearchAdvanced.ascx.cs" Inherits="SplendidCRM.Users.SearchAdvanced" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
			...
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td width="15%" class="dataLabel"><%= L10n.Term("Users.LBL_USER_NAME") %></td>
					...
					<tr>
						<td class="dataLabel"><%= L10n.Term("Users.LBL_LAST_NAME") %></td>
