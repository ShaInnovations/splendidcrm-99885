<%@ Page language="c#" Codebehind="Login.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Users.Login" %>
...
<form id="frmMain" method="post" runat="server">
	...
	<SplendidCRM:Header ID="ctlHeader" ActiveTab="Login" EnableShortcuts="false" EnableLastViewed="false" Runat="Server" />
	...
	<SplendidCRM:Footer ID="ctlFooter" Runat="Server" />
</form>
</body>
</html>
