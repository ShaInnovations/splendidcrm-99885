<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SearchAdvanced.ascx.cs" Inherits="SplendidCRM.Leads.SearchAdvanced" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="15%" class="dataLabel"><%= L10n.Term("Leads.LBL_FIRST_NAME") %></td>
						<td width="30%" class="dataField"><asp:TextBox ID="txtFIRST_NAME" TabIndex="1" Size="25" MaxLength="25" Runat="server" /></td>
						<td width="15%" class="dataLabel"><%= L10n.Term("Leads.LBL_ANY_PHONE") %></td>
						<td width="30%" class="dataField"><asp:TextBox ID="txtPHONE" TabIndex="2" Size="20" MaxLength="25" Runat="server" /></td>
					...
					<tr>
						...
						<td class="dataLabel"><%= L10n.Term("Leads.LBL_COUNTRY") %></td>
