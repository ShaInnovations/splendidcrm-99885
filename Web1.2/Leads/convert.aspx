<%@ Page language="c#" Codebehind="convert.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Leads.Convert" %>
...
<form id="frmMain" method="post" runat="server">
	...
	<SplendidCRM:Header ID="ctlHeader" Visible="<%# !PrintView %>" ActiveTab="Leads" Runat="Server" />
