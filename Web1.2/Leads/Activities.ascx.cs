...
namespace SplendidCRM.Leads
{
	...
	public class Activities : SplendidControl
	{
...
#if DEBUG
					Page.RegisterClientScriptBlock("vwLEADS_ACTIVITIES", Sql.ClientScriptBlock(cmd));
#endif
					try
					{
		...
		private void InitializeComponent()
		{
			...
			grdOpen   .DynamicColumns("Leads.Activities.Open"   );
			grdHistory.DynamicColumns("Leads.Activities.History");
		}
		#endregion
	}
}
