	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
			...
			<td align="right" nowrap>
				<asp:ImageButton CommandName="Refresh" OnCommand="Page_Command" CssClass="chartToolsLink" AlternateText='<%# L10n.Term("Dashboard.LBL_REFRESH") %>' ImageUrl='<%# Session["themeURL"] + "images/refresh.gif" %>' BorderWidth="0" Width="13" Height="13" ImageAlign="AbsMiddle" Runat="server" />
				...
				<span onclick="toggleDisplay('<%= DivEditName %>'); return false;">
					<asp:ImageButton CommandName="Edit" OnCommand="Page_Command" CssClass="chartToolsLink" AlternateText='<%# L10n.Term("Dashboard.LBL_EDIT") %>' ImageUrl='<%# Session["themeURL"] + "images/edit.gif" %>' BorderWidth="0" Width="13" Height="13" ImageAlign="AbsMiddle" Runat="server" />
