...
<table border="0"  cellpadding="0" cellspacing="0">
	<tr>
		<td nowrap>
			...
			<CustomValidators:DateValidator ID="valDATE" ControlToValidate="txtDATE" CssClass="required" EnableClientScript="false" EnableViewState="false" Enabled="false" Display="dynamic" Runat="server" />
