...
<div id="divEditView">
	...
	<SplendidCRM:ModuleHeader ID="ctlModuleHeader" Module="Calls" EnablePrint="false" EnableHelp="true" Runat="Server" />
	<p>
	...
	<input id="txtINVITEE_ID" type="hidden" runat="server" />
