...
<div id="divSearchInvitees">
	<br />
	<h5 class="listViewSubHeadS1"><%= L10n.Term("Calls.LBL_ADD_INVITEE") %></h5>
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tabForm">
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td class="dataLabel" noWrap><%= L10n.Term("Calls.LBL_FIRST_NAME") %>&nbsp;&nbsp;<asp:TextBox ID="txtFIRST_NAME"   CssClass="dataField" size="10" Runat="server" /></td>
						<td class="dataLabel" noWrap><%= L10n.Term("Calls.LBL_LAST_NAME" ) %>&nbsp;&nbsp;<asp:TextBox ID="txtLAST_NAME"    CssClass="dataField" size="10" Runat="server" /></td>
						<td class="dataLabel" noWrap><%= L10n.Term("Calls.LBL_EMAIL"     ) %>&nbsp;&nbsp;<asp:TextBox ID="txtEMAIL"        CssClass="dataField" size="15" Runat="server" /></td>
						<td align="right">
