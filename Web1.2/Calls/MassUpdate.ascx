	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tabForm">
		<tr>
			<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td class="dataLabel"><%= L10n.Term("Calls.LBL_DATE_TIME") %></td>
						<td class="dataField">
						...
						<td class="dataLabel"><%= L10n.Term("Calls.LBL_STATUS") %></td>
						<td class="dataField"><asp:DropDownList ID="lstSTATUS" DataValueField="NAME" DataTextField="DISPLAY_NAME" Runat="server" /></td>
					</tr>
					<tr>
						<td class="dataLabel"><%= L10n.Term("Calls.LBL_DIRECTION") %></td>
						<td class="dataField"><asp:DropDownList ID="lstDIRECTION" DataValueField="NAME" DataTextField="DISPLAY_NAME" Runat="server" /></td>
					</tr>
				</table>
			</td>
		</tr>
