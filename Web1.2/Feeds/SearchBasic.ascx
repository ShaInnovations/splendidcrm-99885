<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SearchBasic.ascx.cs" Inherits="SplendidCRM.Feeds.SearchBasic" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<div id="divSearch">
		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td class="dataLabel" noWrap><%= L10n.Term("Feeds.LBL_TITLE") %>&nbsp;&nbsp;<asp:TextBox ID="txtTITLE" CssClass="dataField" size="20" Runat="server" /></td>
						<td align="right">
	...
	<%= Utils.RegisterEnterKeyPress(txtTITLE.ClientID, btnSearch.ClientID) %>
</div>
