...
<div id="divNewRecord">
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="leftColumnModuleHead">
		<tr>
			...
			<th style="background-image: url(<%= Sql.ToString(Session["themeURL"]) %>images/moduleTab_middle.gif);" width="100%"><%= L10n.Term("Calendar.LNK_NEW_APPOINTMENT") %></th>
	...
	<table width="100%" cellpadding="3" cellspacing="0" border="0">
		<tr>
			<td align="left" class="leftColumnModuleS3">
				<asp:RadioButton ID="radScheduleCall"    GroupName="grpSchedule" class="radio" Checked="true" Runat="server" /><span class="dataLabel"><%= L10n.Term("Calls.LNK_NEW_CALL"   ) %></span><br>
				<asp:RadioButton ID="radScheduleMeeting" GroupName="grpSchedule" class="radio"                Runat="server" /><span class="dataLabel"><%= L10n.Term("Calls.LNK_NEW_MEETING") %></span><br>
				<p>
