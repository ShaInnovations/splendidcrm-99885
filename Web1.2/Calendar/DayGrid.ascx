				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="monthHeader">
					<tr>
						<td align="list" width="1%" class="monthHeaderPrevTd" nowrap>
							<asp:ImageButton CommandName="Day.Previous" OnCommand="Page_Command" CssClass="NextPrevLink" AlternateText='<%# L10n.Term("Calendar.LBL_PREVIOUS_DAY") %>' ImageUrl='<%# Session["themeURL"] + "images/calendar_previous.gif" %>' BorderWidth="0" Width="6" Height="9" ImageAlign="AbsMiddle" Runat="server" />
						...
						<td align="right" class="monthHeaderNextTd" width="1%" nowrap>
							...
							<asp:ImageButton CommandName="Day.Next" OnCommand="Page_Command" CssClass="NextPrevLink" AlternateText='<%# L10n.Term("Calendar.LBL_NEXT_DAY") %>' ImageUrl='<%# Session["themeURL"] + "images/calendar_next.gif" %>' BorderWidth="0" Width="6" Height="9" ImageAlign="AbsMiddle" Runat="server" />
						</td>
					</tr>
				</table>
			</td>
