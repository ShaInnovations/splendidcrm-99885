		...
		<tr>
			<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td width="15%" class="dataLabel"><%= L10n.Term("Campaigns.LBL_CAMPAIGN_START_DATE") %></td>
					...
					<tr>
						...
						<td class="dataLabel"><%= L10n.Term("Campaigns.LBL_CAMPAIGN_STATUS") %></td>
					...
					<tr>
						...
						<td class="dataField"><asp:DropDownList ID="lstCAMPAIGN_TYPE" DataValueField="NAME" DataTextField="DISPLAY_NAME" Runat="server" /></td>
					</tr>
				</table>
			</td>
		</tr>
