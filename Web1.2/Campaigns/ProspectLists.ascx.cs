...
namespace SplendidCRM.Campaigns
{
	...
	/// </summary>
	public class ProspectLists : SplendidControl
	{
		protected Guid            gID                ;
...
#if DEBUG
					Page.RegisterClientScriptBlock("vwCAMPAIGNS_PROSPECT_LISTS", Sql.ClientScriptBlock(cmd));
#endif
					try
					{
		...
		private void InitializeComponent()
		{
			...
			grdMain.DynamicColumns("Campaigns.ProspectLists");
		}
		#endregion
	}
}
