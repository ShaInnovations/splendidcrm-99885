...
namespace SplendidCRM.Projects
{
	...
	public class Activities : SplendidControl
	{
...
#if DEBUG
					Page.RegisterClientScriptBlock("vwPROJECTS_ACTIVITIES", Sql.ClientScriptBlock(cmd));
#endif
					try
					{
		...
		private void InitializeComponent()
		{
			...
			grdOpen   .DynamicColumns("Project.Activities.Open"   );
			grdHistory.DynamicColumns("Project.Activities.History");
		}
		#endregion
	}
}
