	...
	public class Opportunities : SplendidControl
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if ( !Sql.IsEmptyGuid(gOPPORTUNITY_ID) )
			{
				try
				{
					SqlProcs.spPROJECT_RELATION_Update(gID, "Opportunities", gOPPORTUNITY_ID);
...
#if DEBUG
					Page.RegisterClientScriptBlock("vwPROJECTS_OPPORTUNITIES", Sql.ClientScriptBlock(cmd));
#endif
					try
					{
		...
		private void InitializeComponent()
		{
			...
			grdMain.DynamicColumns("Project.Opportunities");
		}
		#endregion
	}
}
