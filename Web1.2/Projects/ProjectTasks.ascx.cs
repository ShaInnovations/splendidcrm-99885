...
namespace SplendidCRM.Projects
{
	...
	public class ProjectTasks : SplendidControl
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			using ( IDbConnection con = dbf.CreateConnection() )
			{
				...
				sSQL = "select *                       " + ControlChars.CrLf
				     ...
				     + " order by DATE_DUE asc         " + ControlChars.CrLf;
				using ( IDbCommand cmd = con.CreateCommand() )
				{
					cmd.CommandText = sSQL;
					Sql.AddParameter(cmd, "@PROJECT_ID", gID);
#if DEBUG
					Page.RegisterClientScriptBlock("vwPROJECTS_PROJECTTASKS", Sql.ClientScriptBlock(cmd));
#endif
					try
					{
		...
		private void InitializeComponent()
		{
			...
			grdMain.DynamicColumns("Project.ProjectTasks");
		}
		#endregion
	}
}
