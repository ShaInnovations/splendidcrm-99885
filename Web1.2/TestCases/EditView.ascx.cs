	...
	public class EditView : SplendidControl
	{
		...
		protected void Page_Command(Object sender, CommandEventArgs e)
		{
			...
			if ( e.CommandName == "Save" )
			{
				...
				if ( Page.IsValid )
				{
					string sCUSTOM_MODULE = "TEST_CASES";
					...
					using ( IDbConnection con = dbf.CreateConnection() )
					{
						...
						using ( IDbTransaction trn = con.BeginTransaction() )
						{
							try
							{
								SqlProcs.spTEST_CASES_Update(ref gID
									, new DynamicControl(this, "ASSIGNED_USER_ID").ID
									, new DynamicControl(this, "NAME"            ).Text
									, new DynamicControl(this, "TEST_TYPE"       ).SelectedValue
									, new DynamicControl(this, "TEST_PHASE"      ).SelectedValue
									, new DynamicControl(this, "DESCRIPTION"     ).Text
									, new DynamicControl(this, "EXPECTED_RESULTS").Text
									, trn
									);
					...
					if ( !Sql.IsEmptyGuid(gID) || !Sql.IsEmptyGuid(gDuplicateID) )
					{
						...
						using ( IDbConnection con = dbf.CreateConnection() )
						{
							...
							sSQL = "select *                " + ControlChars.CrLf
							     + "  from vwTEST_CASES_Edit" + ControlChars.CrLf
