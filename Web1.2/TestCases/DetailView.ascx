<%@ Control Language="c#" AutoEventWireup="false" Codebehind="DetailView.ascx.cs" Inherits="SplendidCRM.TestCases.DetailView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<%
/**********************************************************************************************************************
...
<div id="divDetailView">
	...
	<SplendidCRM:ModuleHeader ID="ctlModuleHeader" Module="TestCases" EnablePrint="true" EnableHelp="true" Runat="Server" />
