<%@ Page language="c#" Codebehind="view.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.TestCases.View" %>
...
<form id="frmMain" method="post" runat="server">
	...
	<SplendidCRM:Header ID="ctlHeader" Visible="<%# !PrintView %>" ActiveTab="TestCases" Runat="Server" />
	
	<%@ Register TagPrefix="SplendidCRM" Tagname="DetailView" Src="DetailView.ascx" %>
	<SplendidCRM:DetailView ID="ctlDetailView" Visible='<%# SplendidCRM.Security.GetUserAccess("TestCases", "view") >= 0 %>' Runat="Server" />
