<%@ Page language="c#" Codebehind="edit.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.TestCases.Edit" %>
...
<form id="frmMain" method="post" runat="server">
	...
	<SplendidCRM:EditView ID="ctlEditView" Visible='<%# SplendidCRM.Security.GetUserAccess("TestCases", "edit") >= 0 %>' Runat="Server" />
