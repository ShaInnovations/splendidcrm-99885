<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SearchBasic.ascx.cs" Inherits="SplendidCRM.Notes.SearchBasic" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td class="dataLabel" noWrap><%= L10n.Term("Notes.LBL_SUBJECT"     ) %>&nbsp;&nbsp;<asp:TextBox ID="txtNAME"         CssClass="dataField" size="20" Runat="server" /></td>
						<td class="dataLabel" noWrap><%= L10n.Term("Notes.LBL_CONTACT_NAME") %>&nbsp;&nbsp;<asp:TextBox ID="txtCONTACT_NAME" CssClass="dataField" size="20" Runat="server" /></td>
