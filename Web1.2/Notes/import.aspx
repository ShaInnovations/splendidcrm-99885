<%@ Page language="c#" Codebehind="import.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Notes.Import" %>
...
<form id="frmMain" method="post" runat="server">
	...
	<SplendidCRM:Header ID="ctlHeader" Visible="<%# !PrintView %>" ActiveTab="Notes" Runat="Server" />
