<%@ Page language="c#" Codebehind="edit.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Notes.Edit" %>
...
<form id="frmMain" method="post" enctype="multipart/form-data" runat="server">
	...
	<SplendidCRM:Header ID="ctlHeader" Visible="<%# !PrintView %>" ActiveTab="Activities" Runat="Server" />
