...
namespace SplendidCRM.Bugs
{
	...
	public class Activities : SplendidControl
	{
...
#if DEBUG
					Page.RegisterClientScriptBlock("vwBUGS_ACTIVITIES", Sql.ClientScriptBlock(cmd));
#endif
					try
					{
		...
		private void InitializeComponent()
		{
			...
			grdOpen   .DynamicColumns("Bugs.Activities.Open"   );
			grdHistory.DynamicColumns("Bugs.Activities.History");
		}
		#endregion
	}
}
