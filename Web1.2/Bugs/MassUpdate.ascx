		...
		<tr>
			<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td class="dataField"><asp:DropDownList ID="lstRESOLUTION" DataValueField="NAME" DataTextField="DISPLAY_NAME" Runat="server" /></td>
						<td class="dataLabel"><%= L10n.Term("Bugs.LBL_TYPE") %></td>
						<td class="dataField"><asp:DropDownList ID="lstTYPE" DataValueField="NAME" DataTextField="DISPLAY_NAME" Runat="server" /></td>
					</tr>
					<tr>
						<td class="dataLabel"><%= L10n.Term("Bugs.LBL_SOURCE") %></td>
						<td class="dataField"><asp:DropDownList ID="lstSOURCE" DataValueField="NAME" DataTextField="DISPLAY_NAME" Runat="server" /></td>
						<td class="dataLabel"><%= L10n.Term("Bugs.LBL_PRODUCT_CATEGORY") %></td>
						<td class="dataField"><asp:DropDownList ID="lstPRODUCT_CATEGORY" DataValueField="NAME" DataTextField="DISPLAY_NAME" Runat="server" /></td>
					</tr>
				</table>
			</td>
		</tr>
