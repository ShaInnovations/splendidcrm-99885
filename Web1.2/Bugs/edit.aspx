<%@ Page language="c#" Codebehind="edit.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Bugs.Edit" %>
...
<form id="frmMain" method="post" enctype="multipart/form-data" runat="server">
	...
	<SplendidCRM:Header ID="ctlHeader" Visible="<%# !PrintView %>" ActiveTab="Bugs" Runat="Server" />
