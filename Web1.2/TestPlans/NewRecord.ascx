<%@ Control Language="c#" AutoEventWireup="false" Codebehind="NewRecord.ascx.cs" Inherits="SplendidCRM.TestPlans.NewRecord" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<div id="divNewRecord">
	<table border="0" cellpadding="0" cellspacing="0" width="180" class="leftColumnModuleHead">
		<tr>
			...
			<th style="background-image: url(<%= Sql.ToString(Session["themeURL"]) %>images/moduleTab_middle.gif);" width="100%"><%= L10n.Term("TestPlans.LBL_NEW_FORM_TITLE") %></th>
	...
	<table border="0" cellpadding="3" cellspacing="0" width="180">
		<tr>
			<td align="left" class="leftColumnModuleS3">
				<p>
				<%= L10n.Term("TestPlans.LBL_LIST_NAME") %>&nbsp;<asp:Label CssClass="required" Text='<%# L10n.Term(".LBL_REQUIRED_SYMBOL") %>' Runat="server" /><br>
