<%@ Control Language="c#" AutoEventWireup="false" Codebehind="MassUpdate.ascx.cs" Inherits="SplendidCRM.TestPlans.MassUpdate" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="25%" class="dataLabel"><%= L10n.Term("TestPlans.LBL_STATUS") %></td>
					...
					<tr>
						<td width="25%" class="dataLabel"><%= L10n.Term("TestPlans.LBL_TYPE") %></td>
						<td width="25%" class="dataField"><asp:DropDownList ID="lstTEST_PLAN_TYPE" DataValueField="NAME" DataTextField="DISPLAY_NAME" Runat="server" /></td>
