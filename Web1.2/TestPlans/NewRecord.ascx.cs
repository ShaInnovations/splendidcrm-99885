...
namespace SplendidCRM.TestPlans
{
	...
	public class NewRecord : SplendidControl
	{
		...
		protected void Page_Command(Object sender, CommandEventArgs e)
		{
			if ( e.CommandName == "NewRecord" )
			{
				...
				if ( Page.IsValid )
				{
					...
					try
					{
						SqlProcs.spTEST_PLANS_New(ref gID, Sql.ToGuid(lstASSIGNED_USER_ID.SelectedValue), txtNAME.Text);
					}
					catch(Exception ex)
					{
					...
					if ( !Sql.IsEmptyGuid(gID) )
						Response.Redirect("~/TestPlans/view.aspx?ID=" + gID.ToString());
				}
			}
		}
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			reqNAME.ErrorMessage = L10n.Term(".ERR_MISSING_REQUIRED_FIELDS") + " " + L10n.Term("TestPlans.LBL_LIST_NAME") + "<br>";
			if ( !IsPostBack )
			{
