<%@ Control CodeBehind="ListView.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.TestPlans.ListView" %>
...
<div id="divListView">
	...
	<SplendidCRM:ModuleHeader ID="ctlModuleHeader" Module="TestPlans" Title=".moduleList.Home" EnablePrint="true" EnableHelp="true" Runat="Server" />
	<%@ Register TagPrefix="SplendidCRM" Tagname="ListHeader" Src="~/_controls/ListHeader.ascx" %>
	<SplendidCRM:ListHeader Visible="<%# !PrintView %>" Title="TestPlans.LBL_SEARCH_FORM_TITLE" Runat="Server" />
	<asp:PlaceHolder ID="plcSearch" Visible="<%# !PrintView %>" Runat="server" />
	<br>
	<SplendidCRM:ListHeader Title="TestPlans.LBL_LIST_FORM_TITLE" Runat="Server" />
