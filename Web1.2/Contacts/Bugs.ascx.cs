...
namespace SplendidCRM.Contacts
{
	...
	/// </summary>
	public class Bugs : SplendidControl
	{
		protected Guid            gID            ;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			using ( IDbConnection con = dbf.CreateConnection() )
			{
				...
				sSQL = "select *                       " + ControlChars.CrLf
				     ...
				     + " order by BUG_NUMBER           " + ControlChars.CrLf;
				using ( IDbCommand cmd = con.CreateCommand() )
				{
					cmd.CommandText = sSQL;
					Sql.AddParameter(cmd, "@CONTACT_ID", gID);
#if DEBUG
					Page.RegisterClientScriptBlock("vwCONTACTS_BUGS", Sql.ClientScriptBlock(cmd));
#endif
					try
					{
		...
		private void InitializeComponent()
		{
			...
			grdMain.DynamicColumns("Contacts.Bugs");
		}
		#endregion
	}
}
