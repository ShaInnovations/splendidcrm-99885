<%@ Page language="c#" Codebehind="import.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Contacts.Import" %>
...
<form id="frmMain" method="post" runat="server">
	...
	<SplendidCRM:Header ID="ctlHeader" Visible="<%# !PrintView %>" ActiveTab="Contacts" Runat="Server" />
