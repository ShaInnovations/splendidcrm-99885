...
namespace SplendidCRM.Contacts
{
	...
	/// </summary>
	public class Cases : SplendidControl
	{
		protected Guid            gID            ;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			using ( IDbConnection con = dbf.CreateConnection() )
			{
				...
				sSQL = "select *                       " + ControlChars.CrLf
				     ...
				     + " order by CASE_NUMBER          " + ControlChars.CrLf;
				using ( IDbCommand cmd = con.CreateCommand() )
				{
					cmd.CommandText = sSQL;
					Sql.AddParameter(cmd, "@CONTACT_ID", gID);
#if DEBUG
					Page.RegisterClientScriptBlock("vwCONTACTS_CASES", Sql.ClientScriptBlock(cmd));
#endif
					try
					{
		...
		private void InitializeComponent()
		{
			...
			grdMain.DynamicColumns("Contacts.Cases");
		}
		#endregion
	}
}
