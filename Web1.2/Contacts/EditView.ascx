...
<div id="divEditView">
	...
	<SplendidCRM:ModuleHeader ID="ctlModuleHeader" Module="Contacts" EnablePrint="false" EnableHelp="true" Runat="Server" />
	<p>
		...
		<tr>
			<td>
				<table ID="tblMain" width="100%" border="0" cellspacing="0" cellpadding="0" runat="server">
					<tr>
						<th align="left" class="dataField" colspan="4"><h4 class="dataLabel"><%= L10n.Term("Contacts.LBL_CONTACT_INFORMATION") %></h4></th>
					</tr>
				</table>
			</td>
		</tr>
		...
		<tr>
			<td>
				<table ID="tblAddress" width="100%" border="0" cellspacing="0" cellpadding="0" runat="server">
					<tr>
						<th align="left" class="dataLabel" colspan="5"><h4 class="dataLabel"><%= L10n.Term("Contacts.LBL_ADDRESS_INFORMATION") %></h4></th>
					</tr>
				</table>
			</td>
		</tr>
		...
		<tr>
			<td>
				<table ID="tblDescription" width="100%" border="0" cellspacing="0" cellpadding="0" runat="server">
					<tr>
						<th align="left" class="dataLabel" colspan="2"><h4 class="dataLabel"><%= L10n.Term("Contacts.LBL_DESCRIPTION_INFORMATION") %></h4></th>
					</tr>
				</table>
			</td>
		</tr>
