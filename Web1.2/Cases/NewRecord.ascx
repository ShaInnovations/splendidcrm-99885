...
<div id="divNewRecord">
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="leftColumnModuleHead">
		<tr>
			...
			<th style="background-image: url(<%= Sql.ToString(Session["themeURL"]) %>images/moduleTab_middle.gif);" width="100%"><%= L10n.Term("Cases.LBL_NEW_FORM_TITLE") %></th>
	...
	<table width="100%" cellpadding="3" cellspacing="0" border="0">
		<tr>
			<td align="left" class="leftColumnModuleS3">
				<p>
				<%= L10n.Term("Cases.LBL_SUBJECT") %>&nbsp;<asp:Label CssClass="required" Text='<%# L10n.Term(".LBL_REQUIRED_SYMBOL") %>' Runat="server" /><br>
				<asp:TextBox ID="txtNAME" size="27" MaxLength="255" Runat="server" /><br>
				<%= L10n.Term("Cases.LBL_ACCOUNT_NAME") %>&nbsp;<asp:Label CssClass="required" Text='<%# L10n.Term(".LBL_REQUIRED_SYMBOL") %>' Runat="server" /><br>
				...
				<CustomValidators:RequiredFieldValidatorForHiddenInputs ID="reqACCOUNT_ID" ControlToValidate="txtACCOUNT_ID" CssClass="required" Enabled="false" EnableClientScript="false" EnableViewState="false" Runat="server" />
