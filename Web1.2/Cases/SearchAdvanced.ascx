<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SearchAdvanced.ascx.cs" Inherits="SplendidCRM.Cases.SearchAdvanced" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="20%" class="dataLabel"><%= L10n.Term("Cases.LBL_SUBJECT") %></td>
						<td width="25%" class="dataField"><asp:TextBox ID="txtNAME"   TabIndex="1" Size="25" MaxLength="50" Runat="server" /></td>
						<td width="20%" class="dataLabel"><%= L10n.Term("Cases.LBL_CASE_NUMBER") %></td>
						<td width="25%" class="dataField"><asp:TextBox ID="txtCASE_NUMBER" TabIndex="2" Size="10" MaxLength="11" Runat="server" /></td>
