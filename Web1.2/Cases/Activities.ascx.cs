...
namespace SplendidCRM.Cases
{
	...
	public class Activities : SplendidControl
	{
...
#if DEBUG
					Page.RegisterClientScriptBlock("vwCASES_ACTIVITIES", Sql.ClientScriptBlock(cmd));
#endif
					try
					{
		...
		private void InitializeComponent()
		{
			...
			grdOpen   .DynamicColumns("Cases.Activities.Open"   );
			grdHistory.DynamicColumns("Cases.Activities.History");
		}
		#endregion
	}
}
