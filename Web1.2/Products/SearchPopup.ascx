<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SearchPopup.ascx.cs" Inherits="SplendidCRM.Products.SearchPopup" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
