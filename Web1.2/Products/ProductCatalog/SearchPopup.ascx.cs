...
namespace SplendidCRM.Products.ProductCatalog
{
	...
	public class SearchPopup : SearchControl
	{
		...
		protected TextBox  txtMANUFACTURER;
		...
		public override void SqlSearchClause(IDbCommand cmd)
		{
			...
			Sql.AppendParameter(cmd, txtTYPE        .Text,  50, Sql.SqlFilterMode.StartsWith, "TYPE_NAME"        );
			Sql.AppendParameter(cmd, txtCATEGORY    .Text,  50, Sql.SqlFilterMode.StartsWith, "CATEGORY_NAME"    );
			Sql.AppendParameter(cmd, txtMANUFACTURER.Text,  50, Sql.SqlFilterMode.StartsWith, "MANUFACTURER_NAME");
		}
