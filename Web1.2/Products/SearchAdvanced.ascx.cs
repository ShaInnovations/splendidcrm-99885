...
namespace SplendidCRM.Products
{
	...
	public class SearchAdvanced : SearchControl
	{
		...
		protected TextBox      txtDISCOUNT_PRICE    ;
		...
		public override void ClearForm()
		{
			...
			txtDISCOUNT_PRICE .Text     = String.Empty;
		...
		public override void SqlSearchClause(IDbCommand cmd)
		{
			...
			Sql.AppendParameter(cmd, txtDISCOUNT_PRICE .Text         ,  10, Sql.SqlFilterMode.StartsWith, "DISCOUNT_PRICE" );
