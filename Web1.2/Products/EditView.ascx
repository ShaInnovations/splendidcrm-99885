...
<div id="divEditView">
	...
	<SplendidCRM:ModuleHeader ID="ctlModuleHeader" Module="Products" EnablePrint="false" EnableHelp="true" Runat="Server" />
	<p>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0"  class="tabForm">
		<tr>
			<td>
				<table ID="tblCost" width="100%" border="0" cellspacing="0" cellpadding="0" runat="server">
				</table>
			</td>
		</tr>
	</table>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0"  class="tabForm">
		<tr>
			<td>
				<table ID="tblManufacturer" width="100%" border="0" cellspacing="0" cellpadding="0" runat="server">
				</table>
			</td>
		</tr>
	</table>
