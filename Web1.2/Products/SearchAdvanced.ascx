<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SearchAdvanced.ascx.cs" Inherits="SplendidCRM.Products.SearchAdvanced" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="20%" class="dataLabel"><%= L10n.Term("Products.LBL_NAME") %></td>
					...
					<tr>
						<td class="dataLabel"><%= L10n.Term("Products.LBL_TAX_CLASS") %></td>
						...
						<td class="dataLabel"><%= L10n.Term("Products.LBL_STATUS") %></td>
					...
					<tr>
						...
						<td class="dataLabel"><%= L10n.Term("Products.LBL_DISCOUNT_PRICE") %></td>
						<td class="dataField"><asp:TextBox ID="txtDISCOUNT_PRICE" TabIndex="4" Size="10" MaxLength="10" Runat="server" /></td>
					</tr>
					<tr>
						<td class="dataLabel"><%= L10n.Term("Products.LBL_MFT_PART_NUM") %></td>
						<td class="dataField"><asp:TextBox ID="txtMFT_PART_NUM" TabIndex="5" Size="25" MaxLength="50" Runat="server" /></td>
						<td class="dataLabel"><%= L10n.Term("Products.LBL_DATE_COST_PRICE") %></td>
						<td class="dataField"><SplendidCRM:DatePicker ID="ctlDATE_COST_PRICE" Runat="Server" /></td>
					</tr>
					<tr>
						<td class="dataLabel"><%= L10n.Term("Products.LBL_VENDOR_PART_NUM") %></td>
						<td class="dataField"><asp:TextBox ID="txtVENDOR_PART_NUM" TabIndex="7" Size="25" MaxLength="50" Runat="server" /></td>
