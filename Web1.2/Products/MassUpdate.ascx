	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tabForm">
		<tr>
			<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="15%" class="dataLabel"><%= L10n.Term("Products.LBL_DATE_PURCHASED") %></td>
						<td width="35%" class="dataField"><SplendidCRM:DatePicker ID="ctlDATE_PURCHASED" Runat="Server" /></td>
						<td width="15%" class="dataLabel"><%= L10n.Term("Products.LBL_STATUS") %></td>
						<td width="35%" class="dataField"><asp:DropDownList ID="lstSTATUS" DataValueField="NAME" DataTextField="DISPLAY_NAME" Runat="server" /></td>
					</tr>
					<tr>
						<td class="dataLabel"><%= L10n.Term("Products.LBL_DATE_SUPPORT_EXPIRES") %></td>
						<td class="dataField"><SplendidCRM:DatePicker ID="ctlDATE_SUPPORT_EXPIRES" Runat="Server" /></td>
						<td class="dataLabel"><%= L10n.Term("Products.LBL_DATE_SUPPORT_STARTS") %></td>
						<td class="dataField"><SplendidCRM:DatePicker ID="ctlDATE_SUPPORT_STARTS" Runat="Server" /></td>
					</tr>
					<tr>
						<td class="dataLabel"><%= L10n.Term("Products.LBL_BOOK_VALUE_DATE") %></td>
						<td class="dataField"><SplendidCRM:DatePicker ID="ctlBOOK_VALUE_DATE" Runat="Server" /></td>
