<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SearchBasic.ascx.cs" Inherits="SplendidCRM.Products.SearchBasic" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td class="dataLabel" noWrap><%= L10n.Term("Products.LBL_NAME"        ) %>&nbsp;&nbsp;<asp:TextBox      ID="txtNAME"         CssClass="dataField" size="10" Runat="server" /></td>
						<td class="dataLabel" noWrap><%= L10n.Term("Products.LBL_MFT_PART_NUM") %>&nbsp;&nbsp;<asp:TextBox      ID="txtMFT_PART_NUM" CssClass="dataField" size="10" Runat="server" /></td>
						<td class="dataLabel" noWrap><%= L10n.Term("Products.LBL_CATEGORY"    ) %>&nbsp;&nbsp;<asp:DropDownList ID="lstCATEGORY" DataValueField="ID" DataTextField="NAME" Runat="server" /></td>
