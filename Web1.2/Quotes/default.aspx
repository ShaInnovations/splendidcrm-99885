<%@ Page language="c#" Codebehind="default.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Quotes.Default" %>
...
<form id="frmMain" method="post" runat="server">
	...
	<SplendidCRM:Header ID="ctlHeader" Visible="<%# !PrintView %>" ActiveTab="Quotes" NewRecord="~/Quotes/NewRecord.ascx" Runat="Server" />
