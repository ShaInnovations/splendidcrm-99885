...
namespace SplendidCRM.Quotes
{
	...
	public class Activities : SplendidControl
	{
...
#if DEBUG
					Page.RegisterClientScriptBlock("vwQUOTES_ACTIVITIES", Sql.ClientScriptBlock(cmd));
#endif
					try
					{
		...
		private void InitializeComponent()
		{
			...
			grdOpen   .DynamicColumns("Quotes.Activities.Open"   );
			grdHistory.DynamicColumns("Quotes.Activities.History");
		}
		#endregion
	}
}
