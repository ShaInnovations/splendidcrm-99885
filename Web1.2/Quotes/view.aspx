<%@ Page language="c#" Codebehind="view.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Quotes.View" %>
...
<form id="frmMain" method="post" runat="server">
	...
	<SplendidCRM:Header ID="ctlHeader" Visible="<%# !PrintView %>" ActiveTab="Quotes" Runat="Server" />
