...
namespace SplendidCRM.Contracts
{
	...
	public class Contacts : SplendidControl
	{
		...
		protected void Page_Command(object sender, CommandEventArgs e)
		{
			try
			{
				switch ( e.CommandName )
				{
					...
					{
						Guid gCONTACT_ID = Sql.ToGuid(e.CommandArgument);
						SqlProcs.spCONTRACTS_CONTACTS_Delete(gID, gCONTACT_ID);
...
#if DEBUG
					Page.RegisterClientScriptBlock("vwCONTRACTS_CONTACTS", Sql.ClientScriptBlock(cmd));
#endif
					try
					{
		...
		private void InitializeComponent()
		{
			...
			grdMain.DynamicColumns("Contracts.Contacts");
		}
		#endregion
	}
}
