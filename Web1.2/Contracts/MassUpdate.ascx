	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tabForm">
		<tr>
			<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="15%" class="dataLabel"><%= L10n.Term("Contracts.LBL_ACCOUNT_NAME") %></td>
						...
						<td width="15%" class="dataLabel"><%= L10n.Term("Contracts.LBL_STATUS") %></td>
					...
					<tr>
						<td class="dataLabel"><%= L10n.Term("Contracts.LBL_CUSTOMER_SIGNED_DATE") %></td>
						<td class="dataField">
							<SplendidCRM:DatePicker ID="ctlCUSTOMER_SIGNED_DATE" Runat="Server" />
						</td>
						<td class="dataLabel"><%= L10n.Term("Contracts.LBL_COMPANY_SIGNED_DATE") %></td>
						<td class="dataField">
							<SplendidCRM:DatePicker ID="ctlCOMPANY_SIGNED_DATE" Runat="Server" />
						</td>
					</tr>
					<tr>
