...
namespace SplendidCRM.Contracts
{
	...
	public class MassUpdate : SplendidControl
	{
		...
		protected _controls.DatePicker ctlCUSTOMER_SIGNED_DATE;
		protected _controls.DatePicker ctlCOMPANY_SIGNED_DATE ;
		...
		public DateTime CUSTOMER_SIGNED_DATE
		{
			...
			{
				// 07/09/2006 Paul.  Move the date conversion out of the MassUpdate control. 
				return ctlCUSTOMER_SIGNED_DATE.Value;
			}
		}
		...
		public DateTime COMPANY_SIGNED_DATE
		{
			...
			{
				// 07/09/2006 Paul.  Move the date conversion out of the MassUpdate control. 
				return ctlCOMPANY_SIGNED_DATE.Value;
			}
		}
