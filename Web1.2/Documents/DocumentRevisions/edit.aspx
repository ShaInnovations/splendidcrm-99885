<%@ Page language="c#" Codebehind="edit.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.DocumentRevisions.Edit" %>
...
<form id="frmMain" method="post" enctype="multipart/form-data" runat="server">
	...
	<SplendidCRM:Header ID="ctlHeader" Visible="<%# !PrintView %>" ActiveTab="Documents" Runat="Server" />
