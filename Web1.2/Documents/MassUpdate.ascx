	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tabForm">
		<tr>
			<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td class="dataLabel"><%= L10n.Term("Documents.LBL_DOC_ACTIVE_DATE") %></td>
						<td class="dataField">
							<%@ Register TagPrefix="SplendidCRM" Tagname="DatePicker" Src="~/_controls/DatePicker.ascx" %>
							<SplendidCRM:DatePicker ID="ctlACTIVE_DATE" Runat="Server" />
						</td>
						<td class="dataLabel"><%= L10n.Term("Documents.LBL_DOC_EXP_DATE") %></td>
						<td class="dataField">
							<SplendidCRM:DatePicker ID="ctlEXP_DATE" Runat="Server" />
						</td>
					</tr>
					<tr>
						<td width="15%" class="dataLabel"><%= L10n.Term("Documents.LBL_SF_CATEGORY") %></td>
						<td width="35%" class="dataField"><asp:DropDownList ID="lstCATEGORY_ID" DataValueField="NAME" DataTextField="DISPLAY_NAME" Runat="server" /></td>
						<td width="15%" class="dataLabel"><%= L10n.Term("Documents.LBL_SF_SUBCATEGORY") %></td>
						<td width="35%" class="dataField"><asp:DropDownList ID="lstSUBCATEGORY_ID" DataValueField="NAME" DataTextField="DISPLAY_NAME" Runat="server" /></td>
					</tr>
					<tr>
						<td width="15%" class="dataLabel"><%= L10n.Term("Documents.LBL_DOC_STATUS") %></td>
