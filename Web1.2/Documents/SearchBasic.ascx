<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SearchBasic.ascx.cs" Inherits="SplendidCRM.Documents.SearchBasic" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
