...
{
	/// <summary>
	///		Summary description for VerifyViews.
	/// </summary>
	public class VerifyViews : SyncControl
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			try
			{
				...
				try
				{
					litSOURCE_LIST.Text = LoadNames(nodeSource, "Views", "View", lblSOURCE_PROVIDER.Text, lblSOURCE_CONNECTION.Text, GetViewsCommand(lblSOURCE_PROVIDER.Text));
				}
				catch(Exception ex)
				{
				...
				try
				{
					litDESTINATION_LIST.Text = LoadNames(nodeDestination, "Views", "View", lblDESTINATION_PROVIDER.Text, lblDESTINATION_CONNECTION.Text, GetViewsCommand(lblDESTINATION_PROVIDER.Text));
				}
				catch(Exception ex)
				{
				...
				CompareNames(nodeSource, nodeDestination, "Views", "View", ref sbSourceUnique, ref sbDestinationUnique);
