...
{
	/// <summary>
	///		Summary description for VerifyFunctions.
	/// </summary>
	public class VerifyFunctions : SyncControl
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			try
			{
				...
				try
				{
					litSOURCE_LIST.Text = LoadNames(nodeSource, "Functions", "Function", lblSOURCE_PROVIDER.Text, lblSOURCE_CONNECTION.Text, GetFunctionsCommand(lblSOURCE_PROVIDER.Text));
				}
				catch(Exception ex)
				{
				...
				try
				{
					litDESTINATION_LIST.Text = LoadNames(nodeDestination, "Functions", "Function", lblDESTINATION_PROVIDER.Text, lblDESTINATION_CONNECTION.Text, GetFunctionsCommand(lblDESTINATION_PROVIDER.Text));
				}
				catch(Exception ex)
				{
				...
				CompareNames(nodeSource, nodeDestination, "Functions", "Function", ref sbSourceUnique, ref sbDestinationUnique);
