<%@ Page language="c#" Codebehind="default.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Administration.SyncSchema.Default" %>
...
<form id="frmMain" method="post" runat="server">
	...
	<input type="hidden" id="txtStep" runat="server" />
	<input type="hidden" id="txtXML" runat="server" />
	<asp:PlaceHolder ID="plcSyncStep" Visible="<%# !PrintView %>" Runat="server" />
