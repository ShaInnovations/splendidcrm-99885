<%@ Page language="c#" Codebehind="default.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Administration.Currencies.Default" %>
...
<form id="frmMain" method="post" runat="server">
	...
	<SplendidCRM:Header ID="ctlHeader" Visible="<%# !PrintView %>" ActiveTab="AdministrationCurrencies" AdminShortcuts="true" Runat="Server" />
