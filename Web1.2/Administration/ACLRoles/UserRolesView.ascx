		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="20%" class="dataLabel"><%= L10n.Term(".LBL_ASSIGNED_TO") %></td>
						<td width="70%" class="dataField"><asp:DropDownList ID="lstUSERS" DataValueField="ID" DataTextField="USER_NAME" TabIndex="1" AutoPostBack="True" Runat="server" /></td>
						<td width="10%" class="dataLabel" align="right" nowrap>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td style="padding-bottom: 2px;">
				<input ID="btnSelectRole" type="button" class="button" onclick="return RoleMultiSelect();" title='<%# L10n.Term(".LBL_SELECT_BUTTON_TITLE") %>' accessKey='<%# L10n.Term(".LBL_SELECT_BUTTON_KEY") %>' value='<%# L10n.Term(".LBL_SELECT_BUTTON_LABEL") %>' runat="server" />
