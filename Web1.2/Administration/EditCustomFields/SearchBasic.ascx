		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td class="dataLabel" noWrap><%= L10n.Term("EditCustomFields.LBL_MODULE_SELECT") %>&nbsp;&nbsp;<asp:DropDownList ID="lstMODULE_NAME" DataValueField="NAME" DataTextField="DISPLAY_NAME" Runat="server" /></td>
						<td align="right">
