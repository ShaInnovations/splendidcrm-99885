<%@ Page language="c#" Codebehind="default.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Administration.EditCustomFields.Default" %>
...
<form id="frmMain" method="post" runat="server">
	...
	<SplendidCRM:Header ID="ctlHeader" Visible="<%# !PrintView %>" ActiveTab="EditCustomFields" NewRecord="~/Administration/EditCustomFields/NewRecord.ascx" EnableNewRecord='<%# SplendidCRM.Security.IS_ADMIN %>' AdminShortcuts="true" Runat="Server" />
