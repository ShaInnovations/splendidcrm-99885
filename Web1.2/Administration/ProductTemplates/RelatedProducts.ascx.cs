...
namespace SplendidCRM.Administration.ProductTemplates
{
	...
	public class RelatedProductTemplates : SplendidControl
	{
...
#if DEBUG
					Page.RegisterClientScriptBlock("vwPRODUCT_TEMPLATES_PRODUCT_TEMPLATES", Sql.ClientScriptBlock(cmd));
#endif
					try
					{
		...
		private void InitializeComponent()
		{
			...
			grdMain.DynamicColumns("ProductTemplates.ProductTemplates");
		}
		#endregion
	}
}
