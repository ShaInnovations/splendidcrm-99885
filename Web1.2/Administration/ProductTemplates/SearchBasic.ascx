<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SearchBasic.ascx.cs" Inherits="SplendidCRM.Administration.ProductTemplates.SearchBasic" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<div id="divSearch">
		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td class="dataLabel" noWrap><%= L10n.Term("ProductTemplates.LBL_NAME"        ) %>&nbsp;&nbsp;<asp:TextBox      ID="txtNAME"         CssClass="dataField" size="10" Runat="server" /></td>
						<td class="dataLabel" noWrap><%= L10n.Term("ProductTemplates.LBL_MFT_PART_NUM") %>&nbsp;&nbsp;<asp:TextBox      ID="txtMFT_PART_NUM" CssClass="dataField" size="10" Runat="server" /></td>
						<td class="dataLabel" noWrap><%= L10n.Term("ProductTemplates.LBL_CATEGORY"    ) %>&nbsp;&nbsp;<asp:DropDownList ID="lstCATEGORY" DataValueField="ID" DataTextField="NAME" Runat="server" /></td>
	...
	<%= Utils.RegisterEnterKeyPress(txtMFT_PART_NUM.ClientID, btnSearch.ClientID) %>
</div>
