	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td align="left" style="padding-bottom: 2px;">
				<asp:Button ID="btnCreate" CommandName="ProductCategories.Create" OnCommand="Page_Command" CssClass="button" Text='<%# "  " + L10n.Term(".LBL_CREATE_BUTTON_LABEL") + "  " %>' title='<%# L10n.Term(".LBL_CREATE_BUTTON_LABEL") %>' AccessKey='<%# L10n.Term(".LBL_CREATE_BUTTON_KEY") %>' Runat="server" />
