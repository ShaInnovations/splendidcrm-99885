...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td align="left" style="padding-bottom: 2px;">
			...
			<asp:Button ID="btnNew"      CommandName="New"      OnCommand="Page_Command" CssClass="button" Text='<%# "  " + L10n.Term(".LBL_NEW_BUTTON_LABEL"     ) + "  " %>' title='<%# L10n.Term(".LBL_NEW_BUTTON_TITLE"     ) %>' AccessKey='<%# L10n.Term(".LBL_NEW_BUTTON_KEY"     ) %>' Runat="server" />
			<asp:Button ID="btnDefaults" CommandName="Defaults" OnCommand="Page_Command" CssClass="button" Text='<%# "  " + L10n.Term(".LBL_DEFAULTS_BUTTON_LABEL") + "  " %>' title='<%# L10n.Term(".LBL_DEFAULTS_BUTTON_TITLE") %>' AccessKey='<%# L10n.Term(".LBL_DEFAULTS_BUTTON_KEY") %>' Runat="server" />
