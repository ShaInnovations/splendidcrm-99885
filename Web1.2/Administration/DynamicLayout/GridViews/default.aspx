<%@ Page language="c#" Codebehind="default.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Administration.DynamicLayout.GridViews.Default" %>
...
<form id="frmMain" method="post" runat="server">
	...
	<SplendidCRM:Header ID="ctlHeader" Visible="<%# !PrintView %>" ActiveTab="DynamicLayout" AdminShortcuts="true" NewRecord="~/Administration/DynamicLayout/GridViews/NewRecord.ascx" Runat="Server" />
