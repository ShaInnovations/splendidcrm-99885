...
namespace SplendidCRM.Administration.DynamicLayout
{
	...
	public class DynamicLayoutView : SplendidControl
	{
		...
		protected virtual void LayoutView_Bind(DataTable dtFields)
		{
		}

		protected virtual DataTable GetLayoutFields(string sNAME)
		{
			return null;
		}
		...
		public int DynamicTableNewFieldIndex(DataTable dtFields)
		{
			int nFieldIndex = 0;
		...
		public void DynamicTableDelete(DataTable dtFields, int nFieldIndex)
		{
		...
		public void DynamicTableInsert(DataTable dtFields, int nFieldIndex)
		{
		...
		public void DynamicTableMoveUp(DataTable dtFields, int nFieldIndex, int nRowMinimum)
		{
		...
		public void DynamicTableMoveDown(DataTable dtFields, int nFieldIndex)
		{
		...
		protected virtual void Page_Command(Object sender, CommandEventArgs e)
		{
			try
			{
				...
				if ( e.CommandName == "Layout.Delete" )
				{
					...
					DynamicTableDelete(dtFields, nFieldIndex);
				...
				else if ( e.CommandName == "Layout.MoveUp" )
				{
					...
					DynamicTableMoveUp(dtFields, nFieldIndex, nRowMinimum);
					ViewState["dtFields"] = dtFields;
					LayoutView_Bind(dtFields);
					if ( ctlNewRecord != null )
						ctlNewRecord.Clear();
				...
				{
					int nFieldIndex = Sql.ToInteger(e.CommandArgument);
					DynamicTableMoveDown(dtFields, nFieldIndex);
					ViewState["dtFields"] = dtFields;
					LayoutView_Bind(dtFields);
					if ( ctlNewRecord != null )
						ctlNewRecord.Clear();
