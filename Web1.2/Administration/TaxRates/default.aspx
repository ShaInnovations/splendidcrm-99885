<%@ Page language="c#" Codebehind="default.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Administration.TaxRates.Default" %>
...
<form id="frmMain" method="post" runat="server">
	...
	<SplendidCRM:Header ID="ctlHeader" Visible="<%# !PrintView %>" ActiveTab="TaxRates" AdminShortcuts="true" Runat="Server" />
	
	<%@ Register TagPrefix="SplendidCRM" Tagname="ModuleHeader" Src="~/_controls/ModuleHeader.ascx" %>
	<SplendidCRM:ModuleHeader ID="ctlModuleHeader" Module="TaxRates" Title="TaxRates.LBL_MODULE_NAME" EnableModuleLabel="false" EnablePrint="false" EnableHelp="true" Runat="Server" />
