<%@ Control Language="c#" AutoEventWireup="false" Codebehind="MassUpdate.ascx.cs" Inherits="SplendidCRM.Administration.Roles.MassUpdate" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
