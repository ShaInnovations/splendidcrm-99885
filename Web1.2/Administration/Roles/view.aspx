<%@ Page language="c#" ValidateRequest="false" Codebehind="view.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Administration.Roles.View" %>
...
<form id="frmMain" method="post" runat="server">
	...
	<SplendidCRM:Header ID="ctlHeader" Visible="<%# !PrintView %>" ActiveTab="Roles" AdminShortcuts="true" Runat="Server" />
