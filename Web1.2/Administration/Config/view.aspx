<%@ Page language="c#" Codebehind="view.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Administration.Config.View" %>
...
<form id="frmMain" method="post" runat="server">
	...
	<SplendidCRM:Header ID="ctlHeader" Visible="<%# !PrintView %>" ActiveTab="AdministrationConfig" AdminShortcuts="true" Runat="Server" />
	
	<%@ Register TagPrefix="SplendidCRM" Tagname="DetailView" Src="DetailView.ascx" %>
	<SplendidCRM:DetailView ID="ctlDetailView" Visible='<%# SplendidCRM.Security.IS_ADMIN %>' Runat="Server" />
	<asp:Label ID="lblAccessError" Text='<%# L10n.Term(".LBL_UNAUTH_ADMIN") %>' Visible='<%# !SplendidCRM.Security.IS_ADMIN %>' Runat="Server" />
