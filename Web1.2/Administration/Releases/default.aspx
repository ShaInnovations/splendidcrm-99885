<%@ Page language="c#" Codebehind="default.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Administration.Releases.Default" %>
...
<form id="frmMain" method="post" runat="server">
	...
	<SplendidCRM:Header ID="ctlHeader" Visible="<%# !PrintView %>" ActiveTab="Releases" AdminShortcuts="true" Runat="Server" />
