		...
		<tr>
			<td style="padding-bottom: 2px;">
				<div style="DISPLAY: <%= bEnableAdd ? "inline" : "none" %>" >
					<input type="button" class="button" value="<%= L10n.Term(".LBL_ADD_BUTTON") %>" title="<%= L10n.Term(".LBL_ADD_BUTTON_TITLE") %>" accesskey="<%= L10n.Term(".LBL_ADD_BUTTON_KEY") %>" onclick="AddItem(-1);" />
				</div>
