...
<div id="divListView">
	...
	<SplendidCRM:ModuleHeader ID="ctlModuleHeader" Module="Terminology" Title=".LBL_IMPORT" EnablePrint="false" EnableHelp="true" Runat="Server" />
		...
		<tr>
			<td>
				<table border="0" cellspacing="0" cellpadding="0" width="100%">
					<tr>
						<td class="dataLabel"><%= L10n.Term("Import.LBL_SELECT_FILE") %>&nbsp;<asp:Label CssClass="required" Text='<%# L10n.Term(".LBL_REQUIRED_SYMBOL") %>' Runat="server" /></td>
						<td class="dataField">
					...
					<tr>
						<td class="dataLabel"><%= L10n.Term("Administration.LBL_IMPORT_LANGUAGE_TRUNCATE") %></td>
						<td class="dataField"><asp:CheckBox ID="chkTruncate" CssClass="checkbox" Runat="server" /></td>
						<td class="dataLabel">&nbsp;</td>
						<td class="dataField">&nbsp;</td>
					</tr>
					<tr>
						<td class="dataLabel"><%= L10n.Term("Administration.LBL_IMPORT_FORCE_UTF8") %></td>
						<td class="dataField"><asp:CheckBox ID="chkForceUTF8" CssClass="checkbox" Runat="server" /></td>
						<td class="dataLabel">&nbsp;</td>
						<td class="dataField">&nbsp;</td>
					</tr>
				</table>
