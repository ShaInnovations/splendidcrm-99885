		...
		<tr>
			<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td width="15%" class="dataLabel"><%= L10n.Term("Accounts.LBL_TYPE") %></td>
						<td width="35%" class="dataField"><asp:DropDownList ID="lstACCOUNT_TYPE" DataValueField="NAME" DataTextField="DISPLAY_NAME" Runat="server" /></td>
					</tr>
					<tr>
						<td class="dataLabel"><%= L10n.Term("Accounts.LBL_INDUSTRY") %></td>
						<td class="dataField"><asp:DropDownList ID="lstINDUSTRY" DataValueField="NAME" DataTextField="DISPLAY_NAME" Runat="server" /></td>
					</tr>
				</table>
			</td>
		</tr>
