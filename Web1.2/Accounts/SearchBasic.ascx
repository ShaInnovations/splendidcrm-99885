<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SearchBasic.ascx.cs" Inherits="SplendidCRM.Accounts.SearchBasic" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<div id="divSearch">
		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td class="dataLabel" noWrap><%= L10n.Term("Accounts.LBL_ACCOUNT_NAME") %>&nbsp;&nbsp;<asp:TextBox ID="txtNAME"    CssClass="dataField" size="10" Runat="server" /></td>
						<td class="dataLabel" noWrap><%= L10n.Term("Accounts.LBL_CITY"        ) %>&nbsp;&nbsp;<asp:TextBox ID="txtCITY"    CssClass="dataField" size="10" Runat="server" /></td>
						<td class="dataLabel" noWrap><%= L10n.Term("Accounts.LBL_WEBSITE"     ) %>&nbsp;&nbsp;<asp:TextBox ID="txtWEBSITE" CssClass="dataField" size="10" Runat="server" /></td>
						<td class="dataLabel" noWrap><%= L10n.Term("Accounts.LBL_PHONE"       ) %>&nbsp;&nbsp;<asp:TextBox ID="txtPHONE"   CssClass="dataField" size="10" Runat="server" /></td>
	...
	<%= Utils.RegisterEnterKeyPress(txtCITY.ClientID   , btnSearch.ClientID) %>
	<%= Utils.RegisterEnterKeyPress(txtWEBSITE.ClientID, btnSearch.ClientID) %>
	<%= Utils.RegisterEnterKeyPress(txtPHONE.ClientID  , btnSearch.ClientID) %>
</div>
