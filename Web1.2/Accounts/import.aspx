<%@ Page language="c#" Codebehind="import.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Accounts.Import" %>
...
<form id="frmMain" method="post" runat="server">
	...
	<SplendidCRM:Header ID="ctlHeader" Visible="<%# !PrintView %>" ActiveTab="Accounts" Runat="Server" />
