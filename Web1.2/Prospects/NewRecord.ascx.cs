...
namespace SplendidCRM.Prospects
{
	...
	public class NewRecord : SplendidControl
	{
		...
		protected void Page_Command(Object sender, CommandEventArgs e)
		{
			if ( e.CommandName == "NewRecord" )
			{
				...
				if ( Page.IsValid )
				{
					...
					try
					{
						SqlProcs.spPROSPECTS_New(ref gID, txtFIRST_NAME.Text, txtLAST_NAME.Text, txtPHONE_WORK.Text, txtEMAIL1.Text);
					}
					catch(Exception ex)
					{
					...
					if ( !Sql.IsEmptyGuid(gID) )
						Response.Redirect("~/Prospects/view.aspx?ID=" + gID.ToString());
				}
				else
				{
					reqEMAIL1.ErrorMessage = L10n.Term("Prospects.LBL_INVALID_EMAIL") + " " + txtEMAIL1.Text + "<br>";
				}
			}
		}
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			reqLAST_NAME.ErrorMessage = L10n.Term(".ERR_MISSING_REQUIRED_FIELDS") + " " + L10n.Term("Prospects.LBL_LIST_LAST_NAME") + "<br>";
			reqEMAIL1.ErrorMessage = L10n.Term("Prospects.LBL_INVALID_EMAIL") + "<br>";
		}
