...
<table width="100%" border="0" cellpadding="0" cellspacing="0" Visible="<%# !PrintView %>" runat="server">
	<tr>
		<td style="padding-bottom: 2px;">
			...
			<asp:Button ID="btnConvert"   CommandName="Convert"   OnCommand="Page_Command" CssClass="button" Text='<%# " "  + L10n.Term("Prospects.LBL_CONVERT_BUTTON_LABEL") + " "  %>' title='<%# L10n.Term("Prospects.LBL_CONVERT_BUTTON_TITLE") %>' Runat="server" />
