...
<div id="divNewRecord">
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="leftColumnModuleHead">
		<tr>
			...
			<th style="background-image: url(<%= Sql.ToString(Session["themeURL"]) %>images/moduleTab_middle.gif);" width="100%"><%= L10n.Term("Prospects.LBL_NEW_FORM_TITLE") %></th>
	...
	<table width="100%" cellpadding="3" cellspacing="0" border="0">
		<tr>
			<td align="left" class="leftColumnModuleS3">
				<p>
				<%= L10n.Term("Prospects.LBL_FIRST_NAME") %><br>
				<asp:TextBox ID="txtFIRST_NAME" MaxLength="25" Runat="server" /><br>
				<%= L10n.Term("Prospects.LBL_LAST_NAME") %>&nbsp;<asp:Label CssClass="required" Text='<%# L10n.Term(".LBL_REQUIRED_SYMBOL") %>' Runat="server" /><br>
				<asp:TextBox ID="txtLAST_NAME" MaxLength="25" Runat="server" /><br>
				<%= L10n.Term("Prospects.LBL_PHONE") %><br>
				<asp:TextBox ID="txtPHONE_WORK" MaxLength="25" Runat="server" /><br>
				<%= L10n.Term("Prospects.LBL_EMAIL_ADDRESS") %><br>
