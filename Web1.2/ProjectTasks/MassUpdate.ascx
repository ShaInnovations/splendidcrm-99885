		...
		<tr>
			<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td width="15%" class="dataLabel"><%= L10n.Term("Tasks.LBL_STATUS") %></td>
						<td width="35%" class="dataField"><asp:DropDownList ID="lstSTATUS" DataValueField="NAME" DataTextField="DISPLAY_NAME" Runat="server" /></td>
					</tr>
					<tr>
						<td class="dataLabel"><%= L10n.Term("Tasks.LBL_DUE_DATE") %></td>
						<td class="dataField">
							<SplendidCRM:DatePicker ID="ctlDATE_DUE" Runat="Server" />
						</td>
						<td class="dataLabel"><%= L10n.Term("Tasks.LBL_START_DATE") %></td>
						<td class="dataField">
							<SplendidCRM:DatePicker ID="ctlDATE_START" Runat="Server" />
						</td>
					</tr>
					<tr>
						<td class="dataLabel"><%= L10n.Term("Tasks.LBL_PRIORITY") %></td>
