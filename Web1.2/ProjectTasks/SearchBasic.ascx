<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SearchBasic.ascx.cs" Inherits="SplendidCRM.ProjectTasks.SearchBasic" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<div id="divSearch">
		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td class="dataLabel" noWrap><%= L10n.Term("ProjectTask.LBL_NAME"     ) %>&nbsp;&nbsp;<asp:TextBox ID="txtNAME"         CssClass="dataField" size="20" Runat="server" /></td>
						<td class="dataLabel" noWrap><%= L10n.Term("ProjectTask.LBL_PARENT_ID") %>&nbsp;&nbsp;<asp:TextBox ID="txtPROJECT_NAME" CssClass="dataField" size="20" Runat="server" /></td>
	...
	<%= Utils.RegisterEnterKeyPress(txtPROJECT_NAME.ClientID, btnSearch.ClientID) %>
</div>
