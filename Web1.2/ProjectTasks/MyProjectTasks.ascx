...
<div id="divProjectTasksMyProjectTasks">
	...
	<SplendidCRM:ListHeader Title="ProjectTask.LBL_LIST_MY_PROJECT_TASKS" Runat="Server" />
	...
	<SplendidCRM:SplendidGrid id="grdMain" Width="100%" CssClass="listView"
		...
		<Columns>
			<asp:TemplateColumn HeaderText="ProjectTask.LBL_LIST_CLOSE" SortExpression="STATUS" ItemStyle-Width="1%">
				<ItemTemplate>
					<asp:ImageButton CommandName="ProjectTask.Close" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' OnCommand="Page_Command" ImageUrl='<%# Session["themeURL"] + "images/close_inline.gif" %>' AlternateText='<%# L10n.Term("ProjectTask.LBL_LIST_CLOSE") %>' BorderWidth="0" Width="12" Height="14" ImageAlign="AbsMiddle" Runat="server" />
				</ItemTemplate>
			</asp:TemplateColumn>
		</Columns>
