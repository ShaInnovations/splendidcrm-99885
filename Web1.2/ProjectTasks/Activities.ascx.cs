...
namespace SplendidCRM.ProjectTasks
{
	...
	public class Activities : SplendidControl
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			using ( IDbConnection con = dbf.CreateConnection() )
			{
				...
				sSQL = "select *                                 " + ControlChars.CrLf
				     ...
				     + " where PROJECT_TASK_ID = @PROJECT_TASK_ID" + ControlChars.CrLf
...
#if DEBUG
					Page.RegisterClientScriptBlock("vwPROJECT_TASKS_ACTIVITIES", Sql.ClientScriptBlock(cmd));
#endif
					try
					{
		...
		private void InitializeComponent()
		{
			...
			grdOpen   .DynamicColumns("ProjectTask.Activities.Open"   );
			grdHistory.DynamicColumns("ProjectTask.Activities.History");
		}
		#endregion
	}
}
