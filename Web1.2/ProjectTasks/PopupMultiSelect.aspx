<%@ Page language="c#" Codebehind="PopupMultiSelect.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.ProjectTasks.PopupMultiSelect" %>
...
function CancelProjectTask()
{
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td style="padding-bottom: 2px;">
				<input id="btnSelect" type="button" class="button" onclick="SelectProjectTasks();" value='<%= "  " + L10n.Term("ProjectTask.LBL_SELECT_CHECKED_BUTTON_LABEL") + "  " %>' title='<%= L10n.Term("ProjectTask.LBL_SELECT_CHECKED_BUTTON_TITLE") %>' />
				<input id="btnCancel" type="button" class="button" onclick="CancelProjectTasks();" value='<%= "  " + L10n.Term(".LBL_DONE_BUTTON_LABEL"               ) + "  " %>' title='<%= L10n.Term(".LBL_DONE_BUTTON_TITLE"               ) %>' AccessKey='<%= L10n.Term(".LBL_DONE_BUTTON_KEY") %>' />
	...
	<SplendidCRM:SplendidGrid id="grdMain" Width="100%" CssClass="listView"
		...
		<Columns>
			...
			<asp:BoundColumn     HeaderText="ProjectTask.LBL_LIST_SUBJECT"      DataField="NAME"             SortExpression="NAME"         ItemStyle-Width="64%" />
