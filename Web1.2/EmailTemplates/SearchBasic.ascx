<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SearchBasic.ascx.cs" Inherits="SplendidCRM.EmailTemplates.SearchBasic" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<div id="divSearch">
		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td class="dataLabel" noWrap><%= L10n.Term("EmailTemplates.LBL_NAME"       ) %>&nbsp;&nbsp;<asp:TextBox ID="txtNAME"        CssClass="dataField" size="20" Runat="server" /></td>
						<td class="dataLabel" noWrap><%= L10n.Term("EmailTemplates.LBL_DESCRIPTION") %>&nbsp;&nbsp;<asp:TextBox ID="txtDESCRIPTION" CssClass="dataField" size="20" Runat="server" /></td>
						<td align="right">
	...
	<%= Utils.RegisterEnterKeyPress(txtDESCRIPTION.ClientID, btnSearch.ClientID) %>
</div>
