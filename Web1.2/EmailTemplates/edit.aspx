<%@ Page language="c#" ValidateRequest="false" Codebehind="edit.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.EmailTemplates.Edit" %>
...
<form id="frmMain" method="post" runat="server">
	...
	<SplendidCRM:Header ID="ctlHeader" Visible="<%# !PrintView %>" ActiveTab="EmailTemplates" Runat="Server" />
