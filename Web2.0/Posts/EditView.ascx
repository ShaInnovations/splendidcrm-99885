<%@ Control Language="c#" AutoEventWireup="false" Codebehind="EditView.ascx.cs" Inherits="SplendidCRM.Posts.EditView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<%
/**********************************************************************************************************************
...
<div id="divEditView">
	...
	<SplendidCRM:ModuleHeader ID="ctlModuleHeader" Module="Posts" EnablePrint="false" HelpName="EditView" EnableHelp="true" Runat="Server" />
	<p>
	...
	<asp:HiddenField ID="THREAD_ID" runat="server" />
