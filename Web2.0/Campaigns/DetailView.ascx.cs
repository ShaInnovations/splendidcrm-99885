...
namespace SplendidCRM.Campaigns
{
	...
	public class DetailView : SplendidControl
	{
		...
		protected _controls.CampaignButtons ctlDetailButtons;
							...
							using ( IDbCommand cmd = con.CreateCommand() )
							{
								...
								using ( IDataReader rdr = cmd.ExecuteReader(CommandBehavior.SingleRow) )
								{
									if ( rdr.Read() )
									{
										...
										ctlDetailButtons.ShowSendTest   = (sCAMPAIGN_TYPE == "Email");
										ctlDetailButtons.ShowSendEmails = (sCAMPAIGN_TYPE == "Email");
										//ctlDetailButtons.ShowMailMerge = (sCAMPAIGN_TYPE == "Email");
									}
									else
									{
