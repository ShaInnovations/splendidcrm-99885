<%@ Control Language="c#" AutoEventWireup="false" Codebehind="DetailView.ascx.cs" Inherits="SplendidCRM.Forums.DetailView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<%
/**********************************************************************************************************************
...
<div id="divDetailView">
	...
	<SplendidCRM:ModuleHeader ID="ctlModuleHeader" Module="Forums" EnablePrint="true" HelpName="DetailView" EnableHelp="true" Runat="Server" />
