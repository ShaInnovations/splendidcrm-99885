...
<div id="divUsersRoles">
	...
	<SplendidCRM:ListHeader Title="Roles.LBL_MODULE_NAME" Runat="Server" />
	
	<asp:Panel CssClass="button-panel" Visible="<%# SplendidCRM.Security.IS_ADMIN %>" runat="server">
		<asp:Button ID="btnSelectRole" OnClientClick="RoleMultiSelect(); return false;" CssClass="button" Text='<%# "  " + L10n.Term(".LBL_SELECT_BUTTON_LABEL") + "  " %>' ToolTip='<%# L10n.Term(".LBL_SELECT_BUTTON_TITLE") %>' AccessKey='<%# L10n.AccessKey(".LBL_SELECT_BUTTON_KEY") %>' Runat="server" />
	...
	<SplendidCRM:SplendidGrid id="grdMain" Width="100%" CssClass="listView"
		...
		<Columns>
			...
			<asp:TemplateColumn  HeaderText="" ItemStyle-Width="1%" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false">
				<ItemTemplate>
					<div visible="<%# SplendidCRM.Security.IS_ADMIN %>" runat="server">
