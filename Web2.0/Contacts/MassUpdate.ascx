...
<div id="divMassUpdate">
	...
	<asp:Panel CssClass="button-panel" Visible="<%# !PrintView %>" runat="server">
		<!-- 09/28/2006 Paul.  Fixed Sync and Unsync buttons to execute the correct command.  They were perviously pointing to MassUpdate and MassDelete commands. -->
		...
		<asp:Button ID="btnSync"   CommandName="Sync"       OnCommand="Page_Command" CssClass="button" Text='<%# L10n.Term(".LBL_SYNC"  ) %>' Runat="server" />
		<asp:Button ID="btnUnsync" CommandName="Unsync"     OnCommand="Page_Command" CssClass="button" Text='<%# L10n.Term(".LBL_UNSYNC") %>' Runat="server" />
	</asp:Panel>
			...
			<asp:TableCell>
				...
				<asp:Table Width="100%" CellPadding="0" CellSpacing="0" runat="server">
					<asp:TableRow>
						...
						<asp:TableCell Width="15%" CssClass="dataLabel"><asp:Label Text='<%# L10n.Term("Contacts.LBL_ACCOUNT_NAME") %>' runat="server" /></asp:TableCell>
