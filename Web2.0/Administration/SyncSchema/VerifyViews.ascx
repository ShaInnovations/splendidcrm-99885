<%@ Control Language="c#" AutoEventWireup="false" Codebehind="VerifyViews.ascx.cs" Inherits="SplendidCRM.Administration.SyncSchema.VerifyViews" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
	...
	<asp:Table SkinID="tabForm" runat="server">
		<asp:TableRow>
			<asp:TableCell>
				<asp:Table SkinID="tabSearchView" runat="server">
					<asp:TableRow>
						<asp:TableHeaderCell><%= L10n.Term("Administration.LBL_UNIQUE_VIEWS") %></asp:TableHeaderCell>
						<asp:TableHeaderCell><%= L10n.Term("Administration.LBL_UNIQUE_VIEWS") %></asp:TableHeaderCell>
					</asp:TableRow>
					<asp:TableRow>
	...
	<asp:Table SkinID="tabForm" runat="server">
		<asp:TableRow>
			<asp:TableCell>
				<asp:Table SkinID="tabSearchView" runat="server">
					<asp:TableRow>
						<asp:TableHeaderCell><%= L10n.Term("Administration.LBL_ALL_VIEWS") %></asp:TableHeaderCell>
						<asp:TableHeaderCell><%= L10n.Term("Administration.LBL_ALL_VIEWS") %></asp:TableHeaderCell>
					</asp:TableRow>
					<asp:TableRow>
