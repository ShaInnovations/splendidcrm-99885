<%@ Control Language="c#" AutoEventWireup="false" Codebehind="VerifyColumns.ascx.cs" Inherits="SplendidCRM.Administration.SyncSchema.VerifyColumns" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
	...
	<asp:Table SkinID="tabForm" runat="server">
		<asp:TableRow>
			<asp:TableCell>
				<asp:Table SkinID="tabSearchView" runat="server">
					<asp:TableRow>
						<asp:TableHeaderCell><%= L10n.Term("Administration.LBL_UNIQUE_COLUMNS") %></asp:TableHeaderCell>
						<asp:TableHeaderCell><%= L10n.Term("Administration.LBL_UNIQUE_COLUMNS") %></asp:TableHeaderCell>
					</asp:TableRow>
					<asp:TableRow>
	...
	<asp:Table SkinID="tabForm" runat="server">
		<asp:TableRow>
			<asp:TableCell>
				<asp:Table SkinID="tabSearchView" runat="server">
					<asp:TableRow>
						<asp:TableHeaderCell><%= L10n.Term("Administration.LBL_ALL_COLUMNS") %></asp:TableHeaderCell>
						<asp:TableHeaderCell><%= L10n.Term("Administration.LBL_ALL_COLUMNS") %></asp:TableHeaderCell>
					</asp:TableRow>
					<asp:TableRow>
