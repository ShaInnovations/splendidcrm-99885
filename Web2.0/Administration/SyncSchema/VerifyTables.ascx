<%@ Control Language="c#" AutoEventWireup="false" Codebehind="VerifyTables.ascx.cs" Inherits="SplendidCRM.Administration.SyncSchema.VerifyTables" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
	...
	<asp:Table SkinID="tabForm" runat="server">
		<asp:TableRow>
			<asp:TableCell>
				<asp:Table SkinID="tabSearchView" runat="server">
					<asp:TableRow>
						<asp:TableHeaderCell><%= L10n.Term("Administration.LBL_UNIQUE_TABLES") %></asp:TableHeaderCell>
						<asp:TableHeaderCell><%= L10n.Term("Administration.LBL_UNIQUE_TABLES") %></asp:TableHeaderCell>
					</asp:TableRow>
					<asp:TableRow>
	...
	<asp:Table SkinID="tabForm" runat="server">
		<asp:TableRow>
			<asp:TableCell>
				<asp:Table SkinID="tabSearchView" runat="server">
					<asp:TableRow>
						<asp:TableHeaderCell><%= L10n.Term("Administration.LBL_ALL_TABLES") %></asp:TableHeaderCell>
						<asp:TableHeaderCell><%= L10n.Term("Administration.LBL_ALL_TABLES") %></asp:TableHeaderCell>
					</asp:TableRow>
					<asp:TableRow>
