...
<div id="divListView">
	...
	<SplendidCRM:SplendidGrid id="grdMain" Width="100%" CssClass="listView"
		...
		<Columns>
			...
			<asp:HyperLinkColumn HeaderText="Terminology.LBL_LIST_NAME_NAME"    DataTextField="NAME"     SortExpression="NAME"         ItemStyle-Width="22%" ItemStyle-CssClass="listViewTdLinkS1" DataNavigateUrlField="ID" DataNavigateUrlFormatString="edit.aspx?id={0}" />
