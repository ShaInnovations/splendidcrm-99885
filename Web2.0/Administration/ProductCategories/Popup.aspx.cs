...
namespace SplendidCRM.Administration.ProductCategories
{
	...
	public class Popup : SplendidPage
	{
		...
		protected SearchPopup   ctlSearch      ;
		...
		{
			SetPageTitle(L10n.Term("ProductCategories.LBL_LIST_FORM_TITLE"));
			DbProviderFactory dbf = DbProviderFactories.GetFactory();
			using ( IDbConnection con = dbf.CreateConnection() )
			{
				string sSQL;
				sSQL = "select *                        " + ControlChars.CrLf
				     + "  from vwPRODUCT_CATEGORIES_List" + ControlChars.CrLf
		...
		{    
			...
			this.AppendGridColumns(grdMain, "ProductCategories.PopupView");
		}
		#endregion
	}
}
