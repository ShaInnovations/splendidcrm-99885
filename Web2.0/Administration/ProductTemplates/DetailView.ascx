<%@ Control Language="c#" AutoEventWireup="false" Codebehind="DetailView.ascx.cs" Inherits="SplendidCRM.Administration.ProductTemplates.DetailView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<%
/**********************************************************************************************************************
...
<div id="divDetailView">
	...
	<SplendidCRM:ModuleHeader ID="ctlModuleHeader" Module="ProductTemplates" EnablePrint="true" HelpName="DetailView" EnableHelp="true" Runat="Server" />
