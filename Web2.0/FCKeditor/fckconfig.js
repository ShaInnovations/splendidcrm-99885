...
// 04/15/2006 Paul.  Simplify the toolbar for SplendidCRM. 
FCKConfig.ToolbarSets["SplendidCRM"] = [
	['Source','Link','Anchor','Image','Table','-','Bold','Italic','Underline','StrikeThrough','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','Outdent','Indent','-','OrderedList','UnorderedList','TextColor','BGColor'],
	['Style','FontFormat','FontName','FontSize']
] ;

// 12/19/2006 Paul.  We need a way to disable all toolbar actions, so just create a blank toolbar. 
