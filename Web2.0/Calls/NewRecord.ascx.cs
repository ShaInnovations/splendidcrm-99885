...
namespace SplendidCRM.Calls
{
	...
	public class NewRecord : SplendidControl
	{
		...
		protected RequiredFieldValidatorForDatePicker reqDATE_START     ;
		protected RequiredFieldValidator     reqTIME_START     ;
		protected DatePickerValidator        valDATE_START     ;
		protected TimeValidator              valTIME_START     ;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			reqDATE_START.ErrorMessage = L10n.Term(".ERR_MISSING_REQUIRED_FIELDS") + " " + L10n.Term("Calls.LBL_LIST_DATE"   ) + "<br>";
