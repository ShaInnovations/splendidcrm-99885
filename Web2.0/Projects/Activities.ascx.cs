...
namespace SplendidCRM.Projects
{
	...
	public class Activities : SplendidControl
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			using ( IDbConnection con = dbf.CreateConnection() )
			{
				...
				sSQL = "select *                    " + ControlChars.CrLf
				     + "  from vwPROJECTS_ACTIVITIES" + ControlChars.CrLf;
				using ( IDbCommand cmd = con.CreateCommand() )
				{
					...
					if ( bDebug )
						RegisterClientScriptBlock("vwPROJECTS_ACTIVITIES", Sql.ClientScriptBlock(cmd));
		...
		private void InitializeComponent()
		{
			...
			this.AppendGridColumns(grdOpen   , "Project.Activities.Open"   );
			this.AppendGridColumns(grdHistory, "Project.Activities.History");
		}
		#endregion
	}
}
