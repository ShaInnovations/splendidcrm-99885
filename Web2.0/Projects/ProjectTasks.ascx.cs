...
namespace SplendidCRM.Projects
{
	...
	public class ProjectTasks : SplendidControl
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			using ( IDbConnection con = dbf.CreateConnection() )
			{
				...
				using ( IDbCommand cmd = con.CreateCommand() )
				{
					...
					cmd.CommandText += " order by DATE_DUE asc         " + ControlChars.CrLf;
					Sql.AddParameter(cmd, "@PROJECT_ID", gID);

					if ( bDebug )
						RegisterClientScriptBlock("vwPROJECTS_PROJECTTASKS", Sql.ClientScriptBlock(cmd));
		...
		private void InitializeComponent()
		{
			...
			this.AppendGridColumns(grdMain, "Project.ProjectTasks");
		}
		#endregion
	}
}
