...
<div id="divNewRecord">
	...
	<SplendidCRM:HeaderLeft ID="ctlHeaderLeft" Title="Meetings.LBL_NEW_FORM_TITLE" Runat="Server" />

	<asp:Panel Width="100%" CssClass="leftColumnModuleS3" runat="server">
		<asp:RadioButton ID="radScheduleCall"    GroupName="grpSchedule" class="radio"                Runat="server" /><asp:Label Text='<%# L10n.Term("Calls.LNK_NEW_CALL"   ) %>' runat="server" /><br />
		<asp:RadioButton ID="radScheduleMeeting" GroupName="grpSchedule" class="radio" Checked="true" Runat="server" /><asp:Label Text='<%# L10n.Term("Calls.LNK_NEW_MEETING") %>' runat="server" /><br />
		<asp:Label   ID="lblNAME"       Text='<%# L10n.Term("Meetings.LBL_SUBJECT") %>' runat="server" /><asp:Label CssClass="required" Text='<%# L10n.Term(".LBL_REQUIRED_SYMBOL") %>' Runat="server" /><br />
		<asp:TextBox ID="txtNAME"       size="25" MaxLength="50" Runat="server" /><br />
		<asp:Label   ID="lblDATE_START" Text='<%# L10n.Term("Meetings.LBL_DATE") %>' runat="server" />&nbsp;<asp:Label CssClass="required" Text='<%# L10n.Term(".LBL_REQUIRED_SYMBOL") %>' Runat="server" />&nbsp;<asp:Label ID="lblDATEFORMAT" CssClass="dateFormat" runat="server" /><br />
		...
		<asp:Label   ID="lblTIME_START" Text='<%# L10n.Term("Meetings.LBL_TIME") %>' runat="server" />&nbsp;<asp:Label CssClass="required" Text='<%# L10n.Term(".LBL_REQUIRED_SYMBOL") %>' Runat="server" />&nbsp;<asp:Label ID="lblTIMEFORMAT" CssClass="dateFormat" runat="server" /><br />
