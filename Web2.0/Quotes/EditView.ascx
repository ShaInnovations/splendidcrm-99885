...
<div id="divEditView">
	...
	<SplendidCRM:ModuleHeader ID="ctlModuleHeader" Module="Quotes" EnablePrint="false" HelpName="EditView" EnableHelp="true" Runat="Server" />
	<p>
		...
		<asp:TableRow>
			<asp:TableCell>
				<table ID="tblAddress" class="tabEditView" runat="server">
					<tr>
						<th colspan="2"><h4><asp:Label Text='<%# L10n.Term("Quotes.LBL_BILLING_TITLE" ) %>' runat="server" /></h4></th>
						<th>&nbsp;</th>
						<th colspan="2"><h4><asp:Label Text='<%# L10n.Term("Quotes.LBL_SHIPPING_TITLE") %>' runat="server" /></h4></th>
					</tr>
				</table>
			</asp:TableCell>
		</asp:TableRow>
