...
namespace SplendidCRM.Quotes
{
	...
	public class EditView : SplendidControl
	{
		...
		protected SplendidCRM._controls.EditLineItemsView ctlEditLineItemsView;
						...
						using ( IDbTransaction trn = con.BeginTransaction() )
						{
							try
							{
								...
								SqlProcs.spQUOTES_Update
									...
									, new DynamicControl(this, rowCurrent, "QUOTE_TYPE"                      ).SelectedValue
									...
									, new DynamicControl(this, rowCurrent, "QUOTE_STAGE"                     ).SelectedValue
									, new DynamicControl(this, rowCurrent, "PURCHASE_ORDER_NUM"              ).Text
									, new DynamicControl(this, rowCurrent, "ORIGINAL_PO_DATE"                ).DateValue
									, new DynamicControl(this, rowCurrent, "DATE_QUOTE_CLOSED"               ).DateValue
									, new DynamicControl(this, rowCurrent, "DATE_QUOTE_EXPECTED_CLOSED"      ).DateValue
								...
								foreach ( DataRow row in dtLineItems.Rows )
								{
									if ( row.RowState != DataRowState.Deleted )
									{
										...
										{
											SqlProcs.spQUOTES_LINE_ITEMS_Update
												( ref gITEM_ID        
												, gID                 
												, gLINE_GROUP_ID      
												, sLINE_ITEM_TYPE     
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				if ( !IsPostBack )
				{
					string sLOAD_MODULE     = "Quotes"  ;
					string sLOAD_MODULE_KEY = "QUOTE_ID";
					...
					else
					{
						...
						new DynamicControl(this, "DATE_QUOTE_EXPECTED_CLOSED").DateValue = DateTime.Today.AddMonths(1);
