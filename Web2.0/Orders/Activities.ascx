<%@ Control CodeBehind="Activities.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="SplendidCRM.Orders.Activities" %>
<%
/**********************************************************************************************************************
 ...
 *********************************************************************************************************************/
%>
<div id="divOrdersActivitiesOpen">
	<br />
	<%@ Register TagPrefix="SplendidCRM" Tagname="ListHeader" Src="~/_controls/ListHeader.ascx" %>
	<SplendidCRM:ListHeader Title="Activities.LBL_OPEN_ACTIVITIES" Runat="Server" />
	
	<asp:Panel CssClass="button-panel" Visible="<%# !PrintView %>" runat="server">
		<asp:Button Visible='<%# SplendidCRM.Security.GetUserAccess("Tasks"   , "edit") >= 0 %>' CommandName="Tasks.Create"    OnCommand="Page_Command" CssClass="button" Text='<%# " " + L10n.Term("Activities.LBL_NEW_TASK_BUTTON_LABEL"        ) + " " %>' ToolTip='<%# L10n.Term("Activities.LBL_NEW_TASK_BUTTON_TITLE"        ) %>' AccessKey='<%# L10n.AccessKey("Activities.LBL_NEW_TASK_BUTTON_KEY"        ) %>' Runat="server" />
...
<div id="divOrdersActivitiesHistory">
	<br />
