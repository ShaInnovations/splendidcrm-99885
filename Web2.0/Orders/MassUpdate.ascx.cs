...
namespace SplendidCRM.Orders
{
	...
	public class MassUpdate : SplendidCRM.MassUpdate
	{
		...
		protected DropDownList    lstORDER_STAGE          ;
		protected SplendidCRM._controls.DatePicker ctlDATE_ORDER_SHIPPED;
		protected SplendidCRM._controls.DatePicker ctlDATE_ORDER_DUE    ;
		public    CommandEventHandler Command ;
		protected SplendidCRM._controls.TeamAssignedMassUpdate ctlTeamAssignedMassUpdate;
		...
		public string ORDER_STAGE
		{
			get
			{
				return lstORDER_STAGE.SelectedValue;
			}
		}
		...
		public DateTime DATE_ORDER_SHIPPED
		{
			get
			{
				...
				return ctlDATE_ORDER_SHIPPED.Value;
			}
		}
		...
		public DateTime DATE_ORDER_DUE
		{
			...
			{
				// 07/09/2006 Paul.  Move the date conversion out of the MassUpdate control. 
				return ctlDATE_ORDER_DUE.Value;
			}
		}
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			try
			{
				if ( !IsPostBack )
				{
					...
					lstORDER_STAGE  .DataSource = SplendidCache.List("order_stage_dom");
					lstORDER_STAGE  .DataBind();
					lstORDER_STAGE  .Items.Insert(0, new ListItem(L10n.Term(".LBL_NONE"), ""));
				}
			}
			catch(Exception ex)
			{
