<%@ Page language="c#" MasterPageFile="~/PopupView.Master" Codebehind="Popup.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Orders.Popup" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	...
	<SplendidCRM:SearchView ID="ctlSearchView" Module="Orders" IsPopupSearch="true" ShowSearchTabs="false" Visible="<%# !PrintView %>" Runat="Server" />

<script type="text/javascript">
function SelectOrder(sPARENT_ID, sPARENT_NAME)
{
	if ( window.opener != null && window.opener.ChangeOrder != null )
	{
		window.opener.ChangeOrder(sPARENT_ID, sPARENT_NAME);
		window.close();
	}
	else
	{
		alert('Original window has closed.  Order cannot be assigned.' + '\n' + sPARENT_ID + '\n' + sPARENT_NAME);
	}
}
function Clear()
{
...
function Cancel()
{
	...
	<SplendidCRM:ListHeader Title="Orders.LBL_LIST_FORM_TITLE" Runat="Server" />
