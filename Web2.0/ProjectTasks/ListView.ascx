...
<div id="divListView">
	...
	function ChangeSearchProject(sPARENT_ID, sPARENT_NAME)
	{
		document.getElementById('<%= new DynamicControl(ctlSearchView, "PROJECT_ID"  ).ClientID %>').value = sPARENT_ID  ;
		document.getElementById('<%= new DynamicControl(ctlSearchView, "PROJECT_NAME").ClientID %>').value = sPARENT_NAME;
	}
	function SearchProjectPopup()
	{
		ChangeProject = ChangeSearchProject;
