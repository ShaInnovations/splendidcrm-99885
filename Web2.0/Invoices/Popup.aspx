<%@ Page language="c#" MasterPageFile="~/PopupView.Master" Codebehind="Popup.aspx.cs" AutoEventWireup="false" Inherits="SplendidCRM.Invoices.Popup" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	...
	<SplendidCRM:SearchView ID="ctlSearchView" Module="Invoices" IsPopupSearch="true" ShowSearchTabs="false" Visible="<%# !PrintView %>" Runat="Server" />

<script type="text/javascript">
function SelectInvoice(sPARENT_ID, sPARENT_NAME)
{
	if ( window.opener != null && window.opener.ChangeInvoice != null )
	{
		window.opener.ChangeInvoice(sPARENT_ID, sPARENT_NAME);
		window.close();
	}
	else
	{
...
function Cancel()
{
	...
	<SplendidCRM:ListHeader Title="Invoices.LBL_LIST_FORM_TITLE" Runat="Server" />
