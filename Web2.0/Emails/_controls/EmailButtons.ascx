<%@ Control Language="c#" AutoEventWireup="false" Codebehind="EmailButtons.ascx.cs" Inherits="SplendidCRM.Emails._controls.EmailButtons" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Table Width="100%" CellPadding="0" CellSpacing="0" style="padding-bottom: 2px;" runat="server">
	<asp:TableRow>
		<asp:TableCell HorizontalAlign="Left">
			...
			<asp:Button ID="btnSave"   CommandName="Save"   OnCommand="Page_Command" CssClass="button" style="margin-right: 3px;" Text='<%# "  " + L10n.Term("Emails.LBL_SAVE_AS_DRAFT_BUTTON_LABEL") + "  " %>' ToolTip='<%# L10n.Term("Emails.LBL_SAVE_AS_DRAFT_BUTTON_TITLE") %>' AccessKey='<%# L10n.AccessKey("Emails.LBL_SAVE_AS_DRAFT_BUTTON_KEY") %>' Runat="server" />
