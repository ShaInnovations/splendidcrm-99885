...
function Cancel()
{
	...
	<SplendidCRM:SplendidGrid id="grdMain" Width="100%" CssClass="listView"
		...
		<Columns>
			...
			<asp:BoundColumn     HeaderText="Contacts.LBL_LIST_ACCOUNT_NAME"  DataField="ACCOUNT_NAME"     SortExpression="ACCOUNT_NAME" ItemStyle-Width="30%" />
			<asp:TemplateColumn HeaderText="Emails.LBL_LIST_TYPE" SortExpression="ADDRESS_TYPE" ItemStyle-Width="15%">
				<ItemTemplate>
