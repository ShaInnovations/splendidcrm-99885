...
<div id="divNewRecord">
	...
	<SplendidCRM:HeaderLeft ID="ctlHeaderLeft" Title="Prospects.LBL_NEW_FORM_TITLE" Runat="Server" />

	<asp:Panel Width="100%" CssClass="leftColumnModuleS3" runat="server">
		<asp:Label   ID="lblFIRST_NAME" Text='<%# L10n.Term("Prospects.LBL_FIRST_NAME"   ) %>' runat="server" /><br />
		<asp:TextBox ID="txtFIRST_NAME" MaxLength="25" Runat="server" /><br />
		<asp:Label   ID="lblLAST_NAME"  Text='<%# L10n.Term("Prospects.LBL_LAST_NAME"    ) %>' runat="server" />&nbsp;<asp:Label CssClass="required" Text='<%# L10n.Term(".LBL_REQUIRED_SYMBOL") %>' Runat="server" /><br />
		<asp:TextBox ID="txtLAST_NAME"  MaxLength="25" Runat="server" /><br />
		<asp:Label   ID="lblPHONE_WORK" Text='<%# L10n.Term("Prospects.LBL_PHONE"        ) %>' runat="server" /><br />
		<asp:TextBox ID="txtPHONE_WORK" MaxLength="25" Runat="server" /><br />
		<asp:Label   ID="lblEMAIL1"     Text='<%# L10n.Term("Prospects.LBL_EMAIL_ADDRESS") %>' runat="server" /><br />
