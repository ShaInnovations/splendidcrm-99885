...
function Cancel()
{
	...
	<asp:Panel ID="pnlPopupButtons" CssClass="button-panel" runat="server">
		<asp:Button ID="btnPopupSelect" OnClientClick="SelectProspects(); return false;" CssClass="button" Text='<%# "  " + L10n.Term("Prospects.LBL_SELECT_CHECKED_BUTTON_LABEL") + "  " %>' ToolTip='<%# L10n.Term("Prospects.LBL_SELECT_CHECKED_BUTTON_TITLE") %>' runat="server" />
