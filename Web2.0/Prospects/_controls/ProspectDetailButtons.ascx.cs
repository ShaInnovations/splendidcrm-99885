...
namespace SplendidCRM.Prospects._controls
{
	/// <summary>
	///		Summary description for ProspectDetailButtons.
	/// </summary>
	...
	public class ProspectDetailButtons : SplendidCRM._controls.DetailButtons
	{
