...
<asp:Panel CssClass="button-panel" Visible="<%# !PrintView %>" runat="server">
	...
	<asp:Button ID="btnConvert"   CommandName="Convert"   OnCommand="Page_Command" CssClass="button" Text='<%# " "  + L10n.Term("Leads.LBL_CONVERTLEAD"      ) + " "  %>' ToolTip='<%# L10n.Term("Leads.LBL_CONVERTLEAD_TITLE") %>' AccessKey='<%# L10n.AccessKey(".LBL_CONVERTLEAD_BUTTON_KEY") %>' Runat="server" />
