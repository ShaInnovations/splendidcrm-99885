...
namespace SplendidCRM.Leads
{
	...
	public class NewRecord : SplendidControl
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			reqLAST_NAME.ErrorMessage = L10n.Term(".ERR_MISSING_REQUIRED_FIELDS") + " " + L10n.Term("Leads.LBL_LIST_LAST_NAME") + "<br>";
			reqEMAIL1.ErrorMessage = L10n.Term("Leads.LBL_INVALID_EMAIL") + "<br>";
		}
