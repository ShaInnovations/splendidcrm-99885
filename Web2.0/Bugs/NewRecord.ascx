...
<div id="divNewRecord">
	...
	<SplendidCRM:HeaderLeft ID="ctlHeaderLeft" Title="Bugs.LBL_NEW_FORM_TITLE" Runat="Server" />

	<asp:Panel Width="100%" CssClass="leftColumnModuleS3" runat="server">
		<asp:Label        ID="lblNAME"     Text='<%# L10n.Term("Bugs.LBL_SUBJECT") %>' runat="server" />&nbsp;<asp:Label CssClass="required" Text='<%# L10n.Term(".LBL_REQUIRED_SYMBOL") %>' Runat="server" /><br />
		<asp:TextBox      ID="txtNAME"     size="27" MaxLength="255" Runat="server" /><br />
		<asp:Label        ID="lblTYPE"     Text='<%# L10n.Term("Bugs.LBL_TYPE") %>' runat="server" /><br />
		<asp:DropDownList ID="lstTYPE"     DataValueField="NAME" DataTextField="DISPLAY_NAME" Runat="server" /><br />
		<asp:Label        ID="lblRELEASE"  Text='<%# L10n.Term("Bugs.LBL_RELEASE") %>' runat="server" /><br />
		<asp:DropDownList ID="lstRELEASE"  DataValueField="ID" DataTextField="NAME" Runat="server" /><br />
		<asp:Label        ID="lblPRIORITY" Text='<%# L10n.Term("Bugs.LBL_PRIORITY") %>' runat="server" /><br />
		<asp:DropDownList ID="lstPRIORITY" DataValueField="NAME" DataTextField="DISPLAY_NAME" Runat="server" /><br />
