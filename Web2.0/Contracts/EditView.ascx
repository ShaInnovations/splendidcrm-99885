<%@ Control Language="c#" AutoEventWireup="false" Codebehind="EditView.ascx.cs" Inherits="SplendidCRM.Contracts.EditView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<%
/**********************************************************************************************************************
...
<div id="divEditView">
	...
	<SplendidCRM:ModuleHeader ID="ctlModuleHeader" Module="Contracts" EnablePrint="false" HelpName="EditView" EnableHelp="true" Runat="Server" />
	<p>
	...
	{
		return window.open('../Opportunities/Popup.aspx','ContractPopup','width=600,height=400,resizable=1,scrollbars=1');
	}
	</script>
