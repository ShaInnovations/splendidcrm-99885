<%@ Control Language="c#" AutoEventWireup="false" Codebehind="DetailView.ascx.cs" Inherits="SplendidCRM.Payments.DetailView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<%
/**********************************************************************************************************************
...
<div id="divDetailView">
	...
	<SplendidCRM:ModuleHeader ID="ctlModuleHeader" Module="Payments" EnablePrint="true" HelpName="DetailView" EnableHelp="true" Runat="Server" />
	...
	<%@ Register TagPrefix="SplendidCRM" Tagname="Invoices" Src="Invoices.ascx" %>
	<SplendidCRM:Invoices ID="ctlInvoices" Runat="Server" />
