<%@ Control Language="c#" AutoEventWireup="false" Codebehind="MassUpdate.ascx.cs" Inherits="SplendidCRM.Payments.MassUpdate" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
		...
		<asp:TableRow>
			<asp:TableCell>
				...
				<asp:Table Width="100%" CellPadding="0" CellSpacing="0" runat="server">
					<asp:TableRow>
						<asp:TableCell Width="15%" CssClass="dataLabel"><asp:Label Text='<%# L10n.Term("Payments.LBL_PAYMENT_DATE") %>' runat="server" /></asp:TableCell>
						<asp:TableCell Width="35%" CssClass="dataField"><SplendidCRM:DatePicker ID="ctlPAYMENT_DATE" Runat="Server" /></asp:TableCell>
						<asp:TableCell Width="15%" CssClass="dataLabel"><asp:Label Text='<%# L10n.Term("Payments.LBL_PAYMENT_TYPE") %>' runat="server" /></asp:TableCell>
