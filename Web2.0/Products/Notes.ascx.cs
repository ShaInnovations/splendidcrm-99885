...
namespace SplendidCRM.Products
{
	...
	public class Notes : SplendidControl
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			using ( IDbConnection con = dbf.CreateConnection() )
			{
				...
				using ( IDbCommand cmd = con.CreateCommand() )
				{
					...
					cmd.CommandText += "   and PRODUCT_ID = @PRODUCT_ID" + ControlChars.CrLf;
					cmd.CommandText += " order by DATE_MODIFIED asc    " + ControlChars.CrLf;
					Sql.AddParameter(cmd, "@PRODUCT_ID", gID);

					if ( bDebug )
						RegisterClientScriptBlock("vwPRODUCTS_NOTES", Sql.ClientScriptBlock(cmd));
		...
		private void InitializeComponent()
		{
			...
			this.AppendGridColumns(grdMain, "Products.Notes");
		}
		#endregion
	}
}
