...
namespace SplendidCRM.Products
{
	...
	public class MassUpdate : SplendidCRM.MassUpdate
	{
		...
		protected _controls.DatePicker ctlDATE_PURCHASED      ;
		protected _controls.DatePicker ctlDATE_SUPPORT_EXPIRES;
		protected _controls.DatePicker ctlDATE_SUPPORT_STARTS ;
		protected _controls.DatePicker ctlBOOK_VALUE_DATE     ;
		...
		public DateTime DATE_PURCHASED
		{
			get
			{
				...
				return ctlDATE_PURCHASED.Value;
			}
		}
		...
		public DateTime DATE_SUPPORT_EXPIRES
		{
			...
			{
				// 07/09/2006 Paul.  Move the date conversion out of the MassUpdate control. 
				return ctlDATE_SUPPORT_EXPIRES.Value;
			}
		}
		...
		public DateTime DATE_SUPPORT_STARTS
		{
			...
			{
				// 07/09/2006 Paul.  Move the date conversion out of the MassUpdate control. 
				return ctlDATE_SUPPORT_STARTS.Value;
			}
		}
		...
		public DateTime BOOK_VALUE_DATE
		{
			...
			{
				// 07/09/2006 Paul.  Move the date conversion out of the MassUpdate control. 
				return ctlBOOK_VALUE_DATE.Value;
			}
		}
