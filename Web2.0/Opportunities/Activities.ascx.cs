...
namespace SplendidCRM.Opportunities
{
	...
	public class Activities : SplendidControl
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			using ( IDbConnection con = dbf.CreateConnection() )
			{
				...
				sSQL = "select *                         " + ControlChars.CrLf
				     + "  from vwOPPORTUNITIES_ACTIVITIES" + ControlChars.CrLf;
				using ( IDbCommand cmd = con.CreateCommand() )
				{
					...
					if ( bDebug )
						RegisterClientScriptBlock("vwOPPORTUNITIES_ACTIVITIES", Sql.ClientScriptBlock(cmd));
		...
		private void InitializeComponent()
		{
			...
			this.AppendGridColumns(grdOpen   , "Opportunities.Activities.Open"   );
			this.AppendGridColumns(grdHistory, "Opportunities.Activities.History");
		}
		#endregion
	}
}
