...
namespace SplendidCRM.Opportunities
{
	...
	/// </summary>
	public class PopupMultiSelect : SplendidPage
	{
		...
		{
			SetPageTitle(L10n.Term("Opportunities.LBL_LIST_FORM_TITLE"));
				...
				using ( IDbCommand cmd = con.CreateCommand() )
				{
					...
					try
					{
						using ( DbDataAdapter da = dbf.CreateDataAdapter() )
						{
							...
							{
								da.Fill(dt);
								// 09/03/2005 Paul. SALES_STAGE is not displayed. 
		...
		{    
			...
			this.AppendGridColumns(grdMain, "Opportunities.PopupView");
		}
		#endregion
	}
}
