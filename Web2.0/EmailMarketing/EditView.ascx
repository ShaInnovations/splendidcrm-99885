...
function EmailTemplatePopup()
{
	...
	return window.open('../EmailTemplates/Popup.aspx?CAMPAIGN_ID=' + fldCAMPAIGN_ID.value,'EmailTemplatePopup','width=750,height=500,resizable=1,scrollbars=1');
}
function EmailTemplateEdit()
{
	var fldTEMPLATE_ID = document.getElementById('<%= new DynamicControl(this, "TEMPLATE_ID").ClientID %>');
	var fldCAMPAIGN_ID = document.getElementById('<%= CAMPAIGN_ID.ClientID %>');
	return window.open('../EmailTemplates/PopupEdit.aspx?ID=' + fldTEMPLATE_ID.value + '&CAMPAIGN_ID=' + fldCAMPAIGN_ID.value,'EmailTemplatePopup','width=750,height=500,resizable=1,scrollbars=1');
}
</script>
