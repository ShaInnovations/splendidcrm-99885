<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ImportButtons.ascx.cs" Inherits="SplendidCRM.Reports._controls.ImportButtons" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Table Width="100%" CellPadding="0" CellSpacing="0" style="padding-bottom: 2px;" runat="server">
	<asp:TableRow>
		<asp:TableCell HorizontalAlign="Left">
			<asp:Button ID="btnImport" CommandName="Import" OnCommand="Page_Command" CssClass="button" style="margin-right: 3px;" Text='<%# "  " + L10n.Term("Reports.LBL_IMPORT_BUTTON_LABEL") + "  " %>' ToolTip='<%# L10n.Term("Reports.LBL_IMPORT_BUTTON_TITLE") %>' Runat="server" />
