...
<asp:Table Width="100%" CellPadding="0" CellSpacing="0" style="padding-bottom: 2px;" runat="server">
	<asp:TableRow>
		<asp:TableCell HorizontalAlign="Left">
			<asp:Button ID="btnRun"    CommandName="Run"    OnCommand="Page_Command" CssClass="button" style="margin-right: 3px;" Text='<%# "  " + L10n.Term("Reports.LBL_RUN_BUTTON_LABEL"  ) + "  " %>' ToolTip='<%# L10n.Term("Reports.LBL_RUN_BUTTON_TITLE"  ) %>' AccessKey='<%# L10n.AccessKey("Reports.LBL_RUN_BUTTON_KEY"  ) %>' Runat="server" />
			<asp:Button ID="btnSave"   CommandName="Save"   OnCommand="Page_Command" CssClass="button" style="margin-right: 3px;" Text='<%# "  " + L10n.Term("Reports.LBL_SAVE_BUTTON_LABEL" ) + "  " %>' ToolTip='<%# L10n.Term("Reports.LBL_SAVE_BUTTON_TITLE" ) %>' AccessKey='<%# L10n.AccessKey("Reports.LBL_SAVE_BUTTON_KEY" ) %>' Runat="server" />
			<asp:Button ID="btnPrint"  CommandName="Print"  OnCommand="Page_Command" CssClass="button" style="margin-right: 3px;" Text='<%# "  " + L10n.Term("Reports.LBL_PRINT_BUTTON_LABEL") + "  " %>' ToolTip='<%# L10n.Term("Reports.LBL_PRINT_BUTTON_TITLE") %>' AccessKey='<%# L10n.AccessKey("Reports.LBL_PRINT_BUTTON_KEY") %>' Visible="false" Runat="server" />
