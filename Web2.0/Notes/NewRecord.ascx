...
<div id="divNewRecord">
	...
	<SplendidCRM:HeaderLeft ID="ctlHeaderLeft" Title="Notes.LBL_NEW_FORM_TITLE" Runat="Server" />

	<asp:Panel Width="100%" CssClass="leftColumnModuleS3" runat="server">
		<asp:Label   ID="lblNAME"        Text='<%# L10n.Term("Notes.LBL_NOTE_SUBJECT") %>' runat="server" />&nbsp;<asp:Label CssClass="required" Text='<%# L10n.Term(".LBL_REQUIRED_SYMBOL") %>' Runat="server" /><br />
		<asp:TextBox ID="txtNAME"        MaxLength="255" Runat="server" /><br />
		<asp:Label   ID="lblDESCRIPTION" Text='<%# L10n.Term("Notes.LBL_NOTE") %>' runat="server" /><br />
		<asp:TextBox ID="txtDESCRIPTION" TextMode="MultiLine" Rows="4" Runat="server" /><br />
	...
	<%= Utils.RegisterEnterKeyPress(txtDESCRIPTION.ClientID, btnSave.ClientID) %>
</div>
